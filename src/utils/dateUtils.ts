...
export const calculateAge = (birthDate: Date | string, deathDate?: Date | string): number => {
...
export const getMemorialAnniversary = (deathDate: Date | string): { date: Date; yearsAgo: number } => {
  ...
  const anniversaryDate = new Date(currentYear, death.getMonth(), death.getDate());
