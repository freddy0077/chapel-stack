...
interface FinancialDataImportScreenProps {
  ...
  setFinancialFile: (file: File | null) => void;
  financialImportError: string | null;
    ...
    >
      ...
      <div className="flex justify-between">
        ...
        <Button
          ...
          disabled={isLoading}
        >
          {financialFile ? "Import and Continue" : "Skip for Now"}
        </Button>
      </div>
    </motion.div>
  );
...
export default FinancialDataImportScreen;
