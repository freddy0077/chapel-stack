...
const SAMPLE_HEADERS = ['First Name', 'Last Name', 'Email', 'Phone', 'Role', 'Branch'];
const SAMPLE_DATA = [
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh]">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
        <h2 className="text-2xl font-bold mb-2 text-indigo-700">Import Members</h2>
        <p className="mb-6 text-gray-600">Upload a CSV or Excel file to import members in bulk. <a href="#" className="text-indigo-600 underline ml-1">Download sample template</a></p>
                ...
                <thead className="bg-indigo-50">
                  <tr>
                    {previewRows[0].map((header: string, i: number) => (
                      <th key={i} className="px-3 py-2 font-semibold text-indigo-700">{header}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
