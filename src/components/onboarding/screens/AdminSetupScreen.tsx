...
const AdminSetupScreen: React.FC<AdminSetupScreenProps> = ({ onNext, onBack, isLoading }) => {
  ...
  const { createSuperAdmin, loading, error: mutationError, success: mutationSuccess } = useCreateSuperAdminUser();
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh]">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
        <h2 className="text-2xl font-bold mb-2 text-indigo-700">Set Up Your Admin Account</h2>
        <p className="mb-6 text-gray-600">Create the first admin user for your organization. This user will have full access and can invite others later.</p>
