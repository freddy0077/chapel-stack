...
const CompletionScreen = ({
  ...
  >
    ...
    <Text className="text-lg text-gray-600 mb-6">
      Your church management system is now ready to use. You&apos;ve
      successfully configured your account with {churchProfile.branches}{" "}
      {churchProfile.branches > 1 ? "locations" : "location"}.
    </Text>
    ...
    <Button color="indigo" size="lg" onClick={onFinish}>
      Go to Dashboard
    </Button>
  </motion.div>
);
