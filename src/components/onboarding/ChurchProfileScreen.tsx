...
const ChurchProfileScreen = ({
  ...
  useEffect(() => {}, [churchProfile, localProfile]);
  ...
  const handleChange = (
    ...
    const updatedProfile = {
      ...localProfile,
      [name]:
        name === "branches" || name === "foundingYear"
  ...
  const handleSubmit = (e?: React.FormEvent) => {
    ...
    if (!localProfile.name || !localProfile.branches || !localProfile.size) {
      alert(
        "Please fill all required fields (Church Name, Number of Branches, and Church Size)",
      );
      return;
    }
  ...
  const isFormValid =
    !!localProfile.name && !!localProfile.branches && !!localProfile.size;
