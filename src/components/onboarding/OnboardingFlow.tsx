...
const onboardingSteps = [
  {
    ...
    description:
      "A comprehensive platform designed to streamline administrative tasks, improve member engagement, and enhance ministry operations across multiple church branches.",
  ...
  // Core System Features
  {
    ...
    description:
      "Manage multiple church locations from a single platform with branch-specific dashboards, permissions, and navigation.",
    features: [
  ...
  },
  {
    ...
    description:
      "Comprehensive member profiles with family mapping, communication preferences, and custom fields.",
    features: [
  ...
  },
  {
    ...
    description:
      "Track attendance for services and events with powerful reporting tools and check-in systems.",
    features: [
  ...
  },
  {
    ...
    description:
      "Create and manage small groups, assign leaders, and track attendance and communication.",
    features: [
  ...
  // Media & Communication
  {
    ...
    description:
      "Upload, manage, and deliver sermon content including video, audio, and notes.",
    features: [
  ...
  },
  {
    ...
    description:
      "Centralized media management with automatic transcoding and organization features.",
    features: [
  ...
  },
  {
    ...
    description:
      "Multi-channel messaging with targeting, templates, and automated follow-ups.",
    features: [
  ...
  // Administration
  {
    ...
    description:
      "Create, manage, and track events with registration, room booking, and attendance features.",
    features: [
  ...
  },
  {
    ...
    description:
      "Recruit, schedule, and track volunteers with skill matching and background checks.",
    features: [
  ...
  },
  {
    ...
    title: "Finances",
    description:
      "Track donations, manage budgets, generate reports, and create donor statements.",
    features: [
      "Donation tracking",
      "Budget management",
      "Financial reporting",
  ...
  },
  {
    ...
    description:
      "Protect your data with role-based permissions, multi-tiered authentication, and audit logging.",
    features: [
  ...
  // Integration Features
  {
    ...
    description:
      "Access your church system on mobile with personalized content, notifications, and giving tools.",
    features: [
      "Member app access",
  ...
  },
  {
    ...
    description:
      "Synchronize your church website with content, events, sermons, and online forms.",
    features: [
  ...
  },
  {
    ...
    description:
      "You're now ready to start using your Church Management System. Remember that help is always available if you need it.",
...
export default function OnboardingFlow({
  ...
  const handleSkip = () => {
    ...
    const nextCategoryStep = onboardingSteps.findIndex(
      (step, index) => index > currentStep && step.category !== currentCategory,
    );
  ...
  const progress = Math.round(
    (completedSteps.length / (onboardingSteps.length - 1)) * 100,
  );
      ...
      <div className="mb-8">
        ...
        <div className="flex justify-between mb-2">
          {categories.map((category, index) => {
            ...
            const firstStepInCategory = onboardingSteps.findIndex(
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            ...
            <div className="md:w-2/5 flex justify-center">
              <div className="relative w-64 h-64">
                ...
                <div
                  className={`bg-${step.color}-100 w-64 h-64 rounded-full flex items-center justify-center`}
                >
            ...
            <div className="md:w-3/5">
              ...
              <Title className="text-2xl font-bold mb-4">{step.title}</Title>
