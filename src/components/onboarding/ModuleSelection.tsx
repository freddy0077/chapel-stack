  ...
  },
  {
    ...
    subModules: [
      ...
      },
      {
        ...
        description:
          "Branch-level bookkeeping for collections, tithes, pledges, and more.",
        icon: CurrencyDollarIcon,
        required: false,
      },
      {
      ...
      },
      {
        ...
        description:
          "Automate church management tasks with intelligent workflows",
        icon: BoltIcon,
        required: false,
      },
    ],
...
export default function ModuleSelection({
  ...
  const toggleAllSubModules = (module: Module) => {
    ...
    const allSelected = nonRequiredSubModules.every((id) =>
    ...
    if (allSelected) {
      ...
      setSelectedModules(
        selectedModules.filter((id) => !nonRequiredSubModules.includes(id)),
      );
    } else {
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <Text className="text-lg text-gray-600 max-w-2xl mx-auto">
          Select the modules and features you need for your church. You can
          always update your selections later.
        </Text>
      </div>

      <div className="flex justify-end mb-4 space-x-2">
        <Button variant="light" onClick={selectAllModules}>
          Select All Features
        </Button>
      </div>
      ...
      <div className="space-y-4">
        {availableModules.map((module) => (
          <Card
            key={module.id}
            className={`overflow-hidden border-l-4 border-${module.color}-500 hover:shadow-md transition-shadow`}
          >
            <div
            ...
            >
              ...
              <div className="flex items-center space-x-4">
                <div className="text-sm text-gray-600">
                  {getSelectedSubModuleCount(module)}/{module.subModules.length}{" "}
                  Features
                </div>
                <ChevronRightIcon
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {module.subModules.map((subModule) => (
                    <div
                      ...
                      onClick={() =>
                        toggleModule(subModule.id, subModule.required)
                      }
                    >
