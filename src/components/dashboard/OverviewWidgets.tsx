...
export function OverviewWidgets({ branches, members, attendance }: OverviewWidgetsProps) {
  const widgets = [
    ...
    { label: "Active Members", value: members ?? 0, icon: (
      <svg width="28" height="28" fill="none" viewBox="0 0 28 28"><circle cx="14" cy="10" r="5" fill="#2563eb"/><ellipse cx="14" cy="20" rx="9" ry="5" fill="#e0e7ef"/></svg>
    ) },
