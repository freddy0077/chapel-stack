...
export function BranchOverviewWidgets({ branchName }: { branchName: string }) {
  // Replace with real branch data
  const widgets = [
    { label: "Active Members", value: 320 },
    { label: "New Members This Month", value: 8 },
    { label: "Attendance (Sunday)", value: 280 },
    { label: "Volunteers", value: 34 },
