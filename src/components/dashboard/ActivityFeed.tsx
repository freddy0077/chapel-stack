...
const activities = [
  ...
  { type: "contribution", desc: "₵500 received from John Doe", time: "10m ago" },
...
export const ActivityFeed = () => (
  <div className="bg-white/80 dark:bg-black/40 backdrop-blur-lg rounded-2xl shadow-xl p-7 border border-white/40 dark:border-black/40 flex flex-col gap-6 min-h-[220px]">
    <div>
      <div className="font-semibold text-gray-700 dark:text-gray-200 mb-2 text-lg">Recent Activity</div>
    ...
    <div>
      <div className="font-semibold text-gray-700 dark:text-gray-200 mb-2 text-lg">Pending Approvals</div>
      <ul className="space-y-2">
        {approvals.map((a, i) => (
          <li key={i} className="flex items-center gap-2 text-sm text-yellow-700 dark:text-yellow-300">
