    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">Comparative Period Analysis</h3>
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="text-center py-8">
          <div className="text-red-500 mb-2">⚠️ Error loading comparative analysis</div>
  ...
  if (!analysisData || !analysisData.data.length) {
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="text-center py-8">
          <div className="text-gray-400 mb-2">📊 No comparative data available</div>
          <p className="text-gray-500 text-sm">
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-sm font-medium text-blue-800">Avg Income Growth</span>
              <p className="text-xl font-bold text-blue-900 mt-1">
                {formatPercentage(analysisData.averageIncomeGrowthRate)}
              </p>
            </div>
            <div className={`${getTrendColor(analysisData.averageIncomeGrowthRate)}`}>
        ...
        <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-sm font-medium text-orange-800">Avg Expense Growth</span>
              <p className="text-xl font-bold text-orange-900 mt-1">
                {formatPercentage(analysisData.averageExpenseGrowthRate)}
              </p>
            </div>
            <div className={`${getTrendColor(analysisData.averageExpenseGrowthRate)}`}>
        ...
        <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-sm font-medium text-purple-800">Avg Net Growth</span>
              <p className="text-xl font-bold text-purple-900 mt-1">
                {formatPercentage(analysisData.averageNetGrowthRate)}
              </p>
            </div>
            <div className={`${getTrendColor(analysisData.averageNetGrowthRate)}`}>
      ...
      {isClient && (
        <div className="space-y-6">
          ...
          <div>
            <h4 className="text-md font-medium text-gray-900 mb-3">Growth Rate Comparison</h4>
            <div className="h-80">
          ...
          <div>
            <h4 className="text-md font-medium text-gray-900 mb-3">Period-over-Period Comparison</h4>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={analysisData.data}>
                  ...
                  />
                  <Legend />
                  <Bar dataKey="currentIncome" fill="#10b981" name="Current Income" />
                  <Bar dataKey="previousIncome" fill="#86efac" name="Previous Income" />
                  <Bar dataKey="currentExpenses" fill="#ef4444" name="Current Expenses" />
                  <Bar dataKey="previousExpenses" fill="#fca5a5" name="Previous Expenses" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
