...
export default function WorkflowTemplateModal({
  ...
  const [createWorkflowTemplate, { loading: creating }] = useMutation(
    CREATE_WORKFLOW_TEMPLATE,
    {
      onCompleted: () => {
        toast({
  ...
  const [updateWorkflowTemplate, { loading: updating }] = useMutation(
    UPDATE_WORKFLOW_TEMPLATE,
    {
      onCompleted: () => {
        toast({
  ...
  const renderActionConfig = (
    ...
    const ActionIcon =
      ACTION_TYPES.find((type) => type.value === action.actionType)?.icon ||
      Mail;
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateAction(index, { actionType: value as any })
                }
                disabled={mode === "view"}
              >
                <SelectTrigger>
          ...
          {action.actionType === "EMAIL" && (
            <div className="space-y-3">
              ...
              <div>
                <Label htmlFor={`action-template-${index}`}>
                  Email Template
                </Label>
                <Textarea
          ...
          {action.actionType === "NOTIFICATION" && (
            <div className="space-y-3">
              <div>
                <Label htmlFor={`action-title-${index}`}>
                  Notification Title
                </Label>
                <Input
              ...
              <div>
                <Label htmlFor={`action-notification-message-${index}`}>
              ...
              onValueChange={(value) =>
                updateAction(index, {
                  actionConfig: {
                    ...action.actionConfig,
                    recipients: {
                      ...action.actionConfig.recipients,
                      type: value,
                    },
                  },
                })
