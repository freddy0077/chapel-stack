...
export const DeathRegisterManagement: React.FC<
  DeathRegisterManagementProps
> = ({ organisationId, branchId }) => {
  ...
  const handleFilterChange = useCallback(
    (newFilters: Partial<DeathRegisterFilterInput>) => {
      setFilters((prev) => ({
        ...prev,
        ...newFilters,
        skip: 0,
  ...
  const handleMarkFamilyNotified = useCallback(
    async (id: string) => {
      try {
    ...
    return (
      <Card className="p-6">
        <div className="text-center">
          ...
          <Title className="text-red-600 mb-2">
            Error Loading Death Registers
          </Title>
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <Text className="text-gray-600">
            Manage deceased member records and memorial information
          </Text>
        </div>
        <Button
          ...
          <div className="p-8 text-center">
            ...
            <Text className="text-gray-500 mb-4">
              {searchTerm
                ...
                : "Start by adding a death record."}
            </Text>
                ...
                <Flex justifyContent="between" alignItems="start">
                  <div className="flex-1">
                    <Flex alignItems="center" className="space-x-3 mb-2">
                      ...
                      <div>
                        <Title className="text-lg font-semibold">
                          {record.member.firstName} {record.member.middleName}{" "}
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-lg">
                          {getBurialTypeIcon(record.burialCremation)}
                        </span>
                        <Badge
                          color={getBurialTypeColor(record.burialCremation)}
                        >
                    ...
                    <Flex className="mt-4 space-x-2">
                      ...
                      {record.funeralEvent && (
                        <Badge color="blue">Funeral Service Scheduled</Badge>
                      )}

                      {record.deathCertificateUrl && (
                        <Badge color="gray">Certificate Available</Badge>
                      )}
                    </Flex>
                  </div>
      ...
      >
        <DialogPanel className="max-w-md">
          ...
          <Text className="text-gray-600 mb-6">
            Are you sure you want to delete this death register? This action
            cannot be undone.
          </Text>
