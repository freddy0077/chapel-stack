...
export const MemorialCalendarSection: React.FC<
  MemorialCalendarSectionProps
> = ({ upcomingMemorials, loading = false }) => {
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg p-6 border border-purple-200">
        <Title className="text-purple-800 mb-4">
          Upcoming Memorial Anniversaries
        </Title>
        {loading ? (
                ...
                <Flex justifyContent="between" alignItems="center">
                  <div>
                    ...
                    <Text className="text-slate-600">
                      {getMemorialAnniversary(memorial.dateOfDeath)} • Died{" "}
          ...
          <Text className="text-slate-600">
            No upcoming memorial anniversaries
          </Text>
        )}
      </div>
    </div>
