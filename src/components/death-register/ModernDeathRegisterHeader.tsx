...
export const ModernDeathRegisterHeader: React.FC<
  ModernDeathRegisterHeaderProps
> = ({ onAddRecord, totalRecords = 0, thisYearRecords = 0 }) => {
  return (
            ...
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-slate-300 text-lg leading-relaxed max-w-2xl">
                  Compassionately manage and honor the memory of departed
                  members with dignity and care
                </p>
