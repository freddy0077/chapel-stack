...
export default function ImprovedEventModal({
  open,
  onClose,
  onEventCreated,
                  ...
                  <div className="flex items-start space-x-3 p-4 bg-white rounded-lg border border-green-100">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Enable this if people need to register to attend this
                        event. Great for planning refreshments and seating!
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="ml-8 space-y-4 border-l-4 border-green-200 pl-6 bg-white/50 rounded-r-lg py-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            Set a capacity limit for the event
                          </p>
                        </div>
                        <div>
                          <label
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            When to stop accepting registrations
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {[
                            ...
                            <label
                              key={day}
                              className="flex items-center space-x-2 bg-white rounded-lg px-3 py-2 border border-gray-200 hover:border-purple-300 transition-colors cursor-pointer"
                            >
                              <input
                                type="checkbox"
                                checked={form.recurrenceDaysOfWeek.includes(
                                  day,
                                )}
                                onChange={(e) => {
                                  if (e.target.checked) {
