...
export function CounselingSessionsManagement({
  className,
}: CounselingSessionsManagementProps) {
  ...
  const handleDeleteSession = async (id: string) => {
    if (
      window.confirm("Are you sure you want to delete this counseling session?")
    ) {
      try {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage and track counseling sessions with members
          </p>
        </div>
              ...
              <div className="relative pt-8 pb-6">
                ...
                <DialogHeader className="text-center">
                  ...
                  <p className="text-pink-100">
                    Create a new counseling session for member support
                  </p>
                </DialogHeader>
              </div>
            </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-orange-600 mt-1">
                        Enable for regular recurring sessions
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center">
