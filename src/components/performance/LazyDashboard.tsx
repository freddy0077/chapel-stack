...
const OverviewWidgets = lazy(() => import('@/components/dashboard/OverviewWidgets').then(m => ({ default: m.OverviewWidgets })));
const FinancesSummary = lazy(() => import('@/components/dashboard/FinancesSummary').then(m => ({ default: m.FinancesSummary })));
const UpcomingEvents = lazy(() => import('@/components/dashboard/UpcomingEvents').then(m => ({ default: m.UpcomingEvents })));
const AdminTools = lazy(() => import('@/components/dashboard/AdminTools').then(m => ({ default: m.AdminTools })));
      ...
      <div className="space-y-8">
        ...
        <Suspense fallback={
          ...
          <FinancesSummary
            ...
            topBranches={dashboard?.financialOverview?.topGivingBranches?.map(b => ({
              branchId: b?.branchId, 
        ...
        <Suspense fallback={
          ...
          <UpcomingEvents events={dashboard?.activityEngagement?.upcomingEvents} />
        </Suspense>
