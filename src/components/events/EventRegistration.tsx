...
const EventRegistration: React.FC<EventRegistrationProps> = ({
  ...
  const isCapacityFull = event.capacity && (event.eventRegistrations?.length || 0) >= event.capacity;
        ...
        <div className="relative p-6">
          ...
          {isDeadlinePassed && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <p className="text-red-800 text-sm font-medium">Registration deadline has passed</p>
            </div>
          )}

          {isCapacityFull && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
              <p className="text-yellow-800 text-sm font-medium">Event is at full capacity</p>
            </div>
          )}

          {!event.registrationRequired && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-blue-800 text-sm font-medium">This event does not require registration</p>
            </div>
          )}

          {/* Registration Form */}
          {event.registrationRequired && !isDeadlinePassed && !isCapacityFull && (
                ...
                <div className="flex items-center space-x-4">
                  <label className="flex items-center">
                    <input
                      ...
                      className="mr-2"
                    />
                    <span className="text-sm font-medium text-gray-700">Register as Member</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
                      ...
                      className="mr-2"
                    />
                    <span className="text-sm font-medium text-gray-700">Register as Guest</span>
                  </label>
                </div>
              )}
