        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div>
            ...
            <select
              value={groupBy}
              onChange={(e) =>
                setGroupBy(e.target.value as AttendanceReportGroupBy)
              }
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
            >
          ...
          <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
            ...
            <div className="max-h-96 overflow-y-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-orange-50 p-3 rounded-lg">
                    ...
                    <p className="text-xl font-semibold text-orange-900">
                      {formatPercentage(
                        currentReport.summary.overallGrowthRate,
                      )}
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  {currentReport.data.length > 5 && (
                    <p className="text-sm text-gray-500 mt-2">
                      Showing 5 of {currentReport.data.length} records. Download
                      the full report to see all data.
                    </p>
                  )}
                </div>
              )}
              ...
              <div className="text-xs text-gray-500">
                Generated on{" "}
                {new Date(currentReport.generatedAt).toLocaleString()} by{" "}
