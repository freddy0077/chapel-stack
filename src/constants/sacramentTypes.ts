...
export const SACRAMENT_REQUIRED_FIELDS: Record<SacramentType, string[]> = {
  [SACRAMENT_TYPES.BAPTISM]: ['dateOfSacrament', 'locationOfSacrament', 'officiantName'],
  [SACRAMENT_TYPES.COMMUNION]: ['dateOfSacrament', 'locationOfSacrament', 'officiantName'],
  [SACRAMENT_TYPES.CONFIRMATION]: ['dateOfSacrament', 'locationOfSacrament', 'officiantName'],
  [SACRAMENT_TYPES.MARRIAGE]: ['dateOfSacrament', 'locationOfSacrament', 'officiantName', 'groomName', 'brideName'],
  [SACRAMENT_TYPES.RECONCILIATION]: ['dateOfSacrament', 'locationOfSacrament', 'officiantName'],
  [SACRAMENT_TYPES.ANOINTING]: ['dateOfSacrament', 'locationOfSacrament', 'officiantName'],
  [SACRAMENT_TYPES.DIACONATE]: ['dateOfSacrament', 'locationOfSacrament', 'officiantName', 'sponsorName'],
  [SACRAMENT_TYPES.PRIESTHOOD]: ['dateOfSacrament', 'locationOfSacrament', 'officiantName', 'sponsorName'],
  [SACRAMENT_TYPES.RCIA]: ['dateOfSacrament', 'locationOfSacrament', 'officiantName'],
};

// Field configurations for form rendering
export const SACRAMENT_FIELD_CONFIGS: Record<SacramentType, {
...
export const SACRAMENT_DESCRIPTIONS: Record<SacramentType, string> = {
  ...
  [SACRAMENT_TYPES.CONFIRMATION]: 'Strengthening of faith through the Holy Spirit',
