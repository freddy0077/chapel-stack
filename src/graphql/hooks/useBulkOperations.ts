...
export const useBulkOperations = () => {
  const [bulkUpdateStatusMutation, { loading: updateStatusLoading }] =
    useMutation<
  ...
  const [bulkAssignGroupMutation, { loading: assignGroupLoading }] =
    useMutation<
  ...
  const bulkExport = async (exportInput: BulkExportInput): Promise<string> => {
