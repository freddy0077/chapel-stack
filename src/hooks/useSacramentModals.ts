  ...
  switch (action.type) {
    ...
    case "CLOSE_MODAL":
      ...
      return {
        ...
        selectedRecord:
          action.modalType === MODAL_TYPES.DETAIL ||
          action.modalType === MODAL_TYPES.EDIT
            ? null
            : state.selectedRecord,
        selectedMemberId:
          action.modalType === MODAL_TYPES.MEMBER_MARRIAGE_HISTORY
            ? null
...
export function useSacramentModals() {
  ...
  const openSacramentModal = useCallback(
  ...
  const closeSacramentModal = useCallback(
    (sacramentType: SacramentType) => {
  ...
  const openMemberMarriageHistory = useCallback(
    (memberId: string) => {
  ...
  return {
    ...
    isMemberMarriageHistoryOpen: isModalOpen(
      MODAL_TYPES.MEMBER_MARRIAGE_HISTORY,
    ),
  };
}
