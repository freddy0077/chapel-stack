            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    <strong>Primary Role:</strong> {primaryRole || "N/A"}
                  </p>
                  <p>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  <p>
                    ...
                    {defaultDashboard || "N/A"}
                  </p>
                  <p>
                    <strong>Default Route:</strong> {defaultRoute || "N/A"}
                  </p>
                  <p>
                    <strong>Allowed Dashboards:</strong>
                  </p>
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    ...
                    {canAccessRoute("/dashboard/super-admin")
                      ? "✅ Allowed"
                      : "❌ Denied"}
                  </p>
                  <p>
                    <strong>/dashboard/branch:</strong>{" "}
                    {canAccessRoute("/dashboard/branch")
                      ? "✅ Allowed"
                      : "❌ Denied"}
                  </p>
                  <p>
                    <strong>/admin:</strong>{" "}
                    {canAccessRoute("/admin") ? "✅ Allowed" : "❌ Denied"}
                  </p>
                  <p>
                    <strong>/members:</strong>{" "}
                    {canAccessRoute("/members") ? "✅ Allowed" : "❌ Denied"}
                  </p>
                </div>
              </div>
              ...
              <div className="bg-purple-50 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    <strong>ADMIN:</strong>{" "}
                    {canAccessDashboard("ADMIN") ? "✅ Allowed" : "❌ Denied"}
                  </p>
                  <p>
                    <strong>BRANCH_ADMIN:</strong>{" "}
                    {canAccessDashboard("BRANCH_ADMIN")
                      ? "✅ Allowed"
                      : "❌ Denied"}
                  </p>
                  <p>
                    <strong>FINANCE:</strong>{" "}
                    {canAccessDashboard("FINANCE") ? "✅ Allowed" : "❌ Denied"}
                  </p>
                  <p>
                    <strong>MEMBER:</strong>{" "}
                    {canAccessDashboard("MEMBER") ? "✅ Allowed" : "❌ Denied"}
                  </p>
                </div>
              </div>
            </div>
