        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <nav className="flex items-center justify-between pt-6 pb-6">
            ...
            <div className="hidden md:flex md:gap-x-8">
              ...
              <a href="#testimonials" className="text-sm font-semibold leading-6 text-gray-900 hover:text-indigo-600">Testimonials</a>
              <a href="#pricing" className="text-sm font-semibold leading-6 text-gray-900 hover:text-indigo-600">Pricing</a>
              <a href="#contact" className="text-sm font-semibold leading-6 text-gray-900 hover:text-indigo-600">Contact</a>
            </div>
          ...
          <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:py-28">
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Church Management System</h1>
      ...
      <div id="features" className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-indigo-600">Comprehensive Management</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Everything you need to manage your church</p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Our Church Management System provides all the tools necessary to run your church efficiently, from member management to financial tracking, event planning, and more.
            </p>
          </div>
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div className="flex flex-col">
                ...
                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Create comprehensive member profiles, track attendance, manage membership pathways, and generate demographic reports.
                  </p>
                </dd>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Process online donations, track pledges, manage budgets, generate financial reports, and handle tax receipts.
                  </p>
                </dd>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Schedule events, book facilities, manage resources, process event registrations, and handle check-ins.
                  </p>
                </dd>
              </div>
            </dl>
      ...
      <div className="bg-indigo-600">
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:justify-between lg:px-8">
          ...
          <div className="mt-10 flex items-center gap-x-6 lg:mt-0 lg:flex-shrink-0">
            ...
            <a href="#contact" className="text-sm font-semibold leading-6 text-white">Learn more <span aria-hidden="true">→</span></a>
          </div>
        </div>
      </div>
      ...
      <footer className="bg-gray-900" aria-labelledby="footer-heading">
        <div className="mx-auto max-w-7xl px-6 py-12 md:py-16 lg:px-8 lg:py-20">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-300 hover:text-white">Member Management</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-300 hover:text-white">Financial Management</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-300 hover:text-white">Ministry & Volunteers</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-300 hover:text-white">Communication Tools</a>
                    </li>
                  </ul>
                </div>
          ...
          <div className="mt-12 border-t border-white/10 pt-8">
            <p className="text-xs leading-5 text-gray-400">© 2025 ChurchMS. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
