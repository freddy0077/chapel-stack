        ...
        <div className="max-w-md relative z-10">
          ...
          <div className="mb-8 flex items-center">
            ...
            <h1 className="ml-4 text-2xl font-bold text-white">
              Divine<span className="text-indigo-300">System</span>
            </h1>
          </div>
          {/* Hero text */}
          ...
          <p className="text-indigo-200 mb-8">
            Sign in to access your dashboard and manage your church activities
            with ease.
          </p>
        </div>
      </div>
          ...
          <div className="relative bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/10 shadow-xl">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <FloatingInput
                ...
                rightIcon={
                  showPassword ? (
                    <EyeSlashIcon className="h-5 w-5 text-indigo-400 cursor-pointer" />
                  ) : (
                    <EyeIcon className="h-5 w-5 text-indigo-400 cursor-pointer" />
                  )
                }
            ...
            <div className="my-6 flex items-center">
              ...
              <span className="mx-4 text-sm text-indigo-300">
                Or continue with
              </span>
              <div className="flex-grow border-t border-white/10"></div>
            </div>
