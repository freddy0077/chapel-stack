...
const MOCK_MINISTRIES: Record<string, Ministry> = {
  "1": {
    ...
    vision:
      "To create an atmosphere where people can encounter God through authentic worship.",
    mission:
      "Equipping and leading the congregation in worship that glorifies God and transforms lives.",
  ...
  "2": {
    ...
    description:
      "Nurtures the spiritual growth of children through age-appropriate teaching and activities.",
    category: "Education",
    meetingDay: "Sunday",
    meetingTime: "9:30 AM",
    ...
    vision:
      "To see children grow in their relationship with Christ and develop a strong spiritual foundation.",
    mission:
      "Providing a safe, fun, and enriching environment where children can learn about Jesus and develop their faith.",
  ...
  "3": {
    ...
    name: "Youth Ministry",
    description:
      "Engages teenagers in faith development through fellowship, teaching, and service.",
    category: "Education",
    meetingDay: "Friday",
    meetingTime: "7:00 PM",
    ...
    vision:
      "To inspire and equip youth to become passionate followers of Christ.",
    mission:
      "Creating a community where teenagers can grow spiritually, build authentic relationships, and discover their God-given purpose.",
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
          <div className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <dd className="mt-1 text-sm text-gray-900">
                {ministry.establishedDate.toLocaleDateString()}
              </dd>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
        <div className="px-4 py-5 sm:px-6">
          ...
          <p className="mt-1 max-w-2xl text-sm text-gray-500">
            Contact information for the ministry leaders
          </p>
        </div>
        ...
        {activeTab === "overview" && (
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Detailed description and core information
              </p>
            </div>
            <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
        ...
        {activeTab === "resources" && (
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Documents, training materials, and assets
              </p>
            </div>
            <div className="border-t border-gray-200">
              <div className="px-4 py-12 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Get started by uploading a resource
                </p>
                <div className="mt-6">
                  <button
                    type="button"
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div className="border-t border-gray-200">
              <div className="px-4 py-12 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Create a budget plan for this ministry
                </p>
                <div className="mt-6">
                  <button
                    type="button"
