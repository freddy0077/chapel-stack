...
import TransactionDetailModal from "@/components/finance/modals/TransactionDetailModal";
...
export default function BranchFinancesPage({
  ...
  const handleModalSubmit = async (formData: ModalFormData) => {
    ...
    try {
      ...
      // Create transaction with correct variable name
      await createTransaction({
        variables: { createTransactionInput: transactionData },
        refetchQueries: [
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-indigo-100 overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200">
                <h2 className="text-lg font-bold text-indigo-900 flex items-center justify-between">
                  ...
                  <span className="text-sm font-normal text-gray-500">
                    {transactionsData?.transactions?.total || 0} total
                  </span>
                </h2>
              </div>
                      ...
                      <div>
                        <p className="text-sm text-gray-700">
                          ...
                          <span className="font-medium">
                            {Math.ceil(
                              (transactionsData?.transactions?.total || 0) / pageSize
                            )}
                          </span>
                        </p>
                      </div>
        ...
        <TransactionDetailModal
          ...
          onVoidSuccess={() => {
            refetch(); // Refetch transactions after voiding
            setShowTransactionDetailModal(false);
            setSelectedTransaction(null);
          }}
        />
