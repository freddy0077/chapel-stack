  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white">
      ...
      <header className="sticky top-0 z-30 bg-gradient-to-br from-indigo-700 to-indigo-600 shadow flex items-center px-4 sm:px-8 py-4">
        ...
        <h1 className="ml-4 text-2xl font-bold text-white tracking-tight flex-1">
          Assets Library
        </h1>
        <Button
          color="indigo"
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-8 py-8">
        ...
        <section className="bg-white rounded-2xl shadow p-6 mb-8 border border-indigo-50">
          <h2 className="font-semibold text-indigo-900 text-lg mb-4">
            Find Assets
          </h2>
        ...
        <section className="bg-white rounded-2xl shadow p-6 border border-indigo-50">
          <h2 className="font-semibold text-indigo-900 text-lg mb-6">
            Your Media Assets
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div
              ...
              onKeyDown={(e) =>
                (e.key === "Enter" || e.key === " ") && setShowUpload(true)
              }
            >
            ...
            {filteredAssets.map((asset) => (
              ...
              >
                ...
                <span className="truncate font-semibold text-indigo-900 text-sm mb-1 text-center w-full px-2">
                  {asset.fileName}
                </span>
                <span className="text-xs text-gray-500 text-center w-full mb-2">
      ...
      <div
        className={`fixed top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl z-50 transition-transform duration-300 ${selectedAsset ? "translate-x-0" : "translate-x-full"}`}
      >
            ...
            <div className="flex flex-col items-center">
              {selectedAsset.thumbnailUrl ? (
                ...
                getAssetIcon(
                  ...
                  "h-16 w-16 text-indigo-400",
                )
              )}
              <span className="font-semibold text-indigo-900 text-lg mt-4 mb-2 text-center">
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <span className="font-medium text-sm">
                    {selectedAsset.uploadedAt.toLocaleDateString()}
                  </span>
                </div>
                <div>
                  <span className="text-gray-500 text-sm">Used In</span>
                  <span className="font-medium text-sm">
                    {selectedAsset.usageLocations.length} items
                  </span>
                </div>
              </div>
              {selectedAsset.dimensions && (
                <div>
                  ...
                  <span className="font-medium text-sm">
                    {selectedAsset.dimensions.width} x{" "}
              ...
              <div>
                ...
                <span className="font-medium text-sm">
                  {selectedAsset.alt || "No alt text provided"}
                </span>
              </div>
