...
const contentTypeCounts = [
  ...
  },
  {
    ...
    icon: UserGroupIcon,
    color: "blue",
    route: "/dashboard/cms/resources",
  },
  {
    name: "Ministry Information",
    count: 18,
    icon: DocumentTextIcon,
    color: "purple",
    route: "/dashboard/cms/ministries",
  },
  {
    name: "Sacramental Templates",
    count: 8,
    icon: DocumentDuplicateIcon,
    color: "red",
    route: "/dashboard/cms/sacramental-templates",
  },
  {
    name: "Pages",
    count: 31,
  ...
  {
    name: "Visitor Follow-ups",
    count: 24,
    icon: FunnelIcon,
    color: "pink",
    route: "/dashboard/cms/followups",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 flex justify-between items-center">
          <div className="flex items-center">
            <h2 className="mr-4 text-lg font-medium text-gray-900">
              Content Dashboard
            </h2>
            <Button
              icon={ArrowPathIcon}
          ...
          {contentTypeCounts.map((type) => (
            <Link key={type.name} href={type.route}>
              <Card decoration="top" decorationColor={type.color as any}>
                <div className="flex items-center">
                  <div
                    className={`p-2 rounded-md bg-${type.color}-100 text-${type.color}-600`}
                  >
