...
export const mockServices = [
  {
    ...
    songs: [
      ...
      { title: "Great Is Thy Faithfulness", key: "E", artist: "Thomas O. Chisholm" },
...
export default function ServicesList({ services, onViewService }: ServicesListProps) {
  ...
  return (
    <div className="mt-6">
      <div className="mb-6 flex items-center justify-between">
        <h2 className="text-xl font-semibold text-gray-800">Upcoming Services</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service) => (
          ...
          >
            <div className={`h-2 ${service.completed ? 'bg-blue-500' : isUpcoming(service.date) ? 'bg-indigo-500' : 'bg-yellow-500'}`}></div>
            <div className="p-5">
              {/* Service Header */}
              <div className="flex justify-between items-start mb-3">
                ...
                <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${getStatusBadgeClass(service.status)}`}>
                  {service.status}
                </span>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center text-sm text-gray-700">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">{formatTime(service.date)}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center text-sm text-gray-700">
                  ...
                  <div className="line-clamp-1">Led by {service.worshipLeader}</div>
                </div>
              </div>
      ...
      {services.length === 0 && (
        <div className="text-center py-12 bg-gray-50 rounded-lg border border-gray-200">
          <svg className="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 6h8M8 10h8M8 14h4" />
          </svg>
          <h3 className="mt-2 text-lg font-medium text-gray-900">No services found</h3>
          <p className="mt-1 text-sm text-gray-500">Get started by creating a new service plan.</p>
          <div className="mt-6">
            <button
              type="button"
