...
import { DocumentIcon, FolderIcon, ArrowDownTrayIcon, MagnifyingGlassIcon } from '@heroicons/react/24/outline';
...
export const mockResources = [
  {
    ...
    description: "Complete worship guide for Easter service including order of service and readings.",
    url: "#",
  ...
  },
  {
    ...
    description: "Church logos, colors, and branding resources for use in worship presentations.",
    url: "#",
  ...
  },
  {
    ...
    description: "Lead sheet with lyrics, chords, and melody for Amazing Grace.",
    url: "#",
  ...
  },
  {
    ...
    description: "Collection of motion backgrounds for Easter service projections.",
    url: "#",
    category: "Media Assets"
  },
  {
    ...
    description: "Guidelines, expectations, and resources for worship team members.",
    url: "#",
  ...
  },
  {
    ...
    description: "Comprehensive guide to operating the church sound system and equipment.",
    url: "#",
  ...
  },
  {
    ...
    description: "Complete script for Good Friday service including readings and cues.",
    url: "#",
    category: "Service Guides"
  },
  {
...
export default function ResourceLibrary({ resources, onViewResource, onUploadResource }: ResourceLibraryProps) {
  const [searchTerm, setSearchTerm] = useState('');
  const [categoryFilter, setCategoryFilter] = useState('All Categories');

  // Get all unique categories from resources
  const allCategories = ['All Categories', ...new Set(resources.map(resource => resource.category))].sort();
  ...
  const getFileIcon = (resource: Resource) => {
    if (resource.type === 'folder') {
      return <FolderIcon className="h-6 w-6 text-yellow-500" aria-hidden="true" />;
    } else {
      return <DocumentIcon className="h-6 w-6 text-blue-500" aria-hidden="true" />;
    }
  };
                  ...
                  {filteredResources.map((resource) => (
                    <tr key={resource.id} className="hover:bg-gray-50">
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        ...
                        <div className="text-xs text-gray-400">by {resource.uploadedBy}</div>
                      </td>
