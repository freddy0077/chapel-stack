...
export default function CreateRehearsalModal({
  ...
  useEffect(() => {
    if (editRehearsal) {
      setFormData({
        ...
        selectedTeamMembers: editRehearsal.teamMembers.map(
          (m) => m.teamMemberId,
        ),
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const teamMembersData: RehearsalAttendee[] =
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-gray-500">
                        Fill out the form below to schedule a rehearsal.
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-2">
                        ...
                        <div className="grid grid-cols-1 gap-x-6 gap-y-8">
                          <div>
                            ...
                            <p className="mt-1 text-sm leading-6 text-gray-600">
                              Select the team members who should attend this
                              rehearsal.
                            </p>
                            {errors.team && (
                              <p className="mt-1 text-sm text-red-600">
                                      ...
                                      >
                                        ...
                                        <div className="ml-3 flex h-6 items-center">
                                          <input
                                            ...
                                            type="checkbox"
                                            checked={formData.selectedTeamMembers.includes(
                                              member.id,
                                            )}
                                            onChange={() =>
                                        ...
                                        >
                                          ...
                                          <div className="ml-3 flex h-6 items-center">
                                            <input
                                              ...
                                              name={`song-${idx}`}
                                              type="checkbox"
                                              checked={formData.songs.includes(
                                                song,
                                              )}
                                              onChange={() =>
