...
export const mockRehearsals: Rehearsal[] = [
  {
    ...
    notes:
      "Focus on transitions between songs. Work on harmonies for 'Amazing Grace'.",
    completed: false,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    notes:
      "Full run-through with choir. Special attention to Easter celebration songs and transitions.",
    completed: false,
  },
];
...
export default function RehearsalTracker({
  ...
  const formatAttendanceStatus = (rehearsal: Rehearsal) => {
    ...
    const attended = rehearsal.teamMembers.filter(
      (m) => m.attended === true,
    ).length;
                        ...
                        >
                          <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              {rehearsal.serviceId
                                ? `For: ${services.find((s) => s.id === rehearsal.serviceId)?.title || "Service"}`
                                : ""}
                            </div>
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            ...
                            <div className="flex items-center mt-1">
                              ...
                              <span>
                                {rehearsal.time} ({rehearsal.duration} mins)
                              </span>
                            </div>
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
