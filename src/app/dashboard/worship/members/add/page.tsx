...
export default function AddTeamMemberPage() {
  ...
  const [formData, setFormData] = useState<
    Omit<TeamMember, "id" | "scheduledServices">
  >({
    name: "",
    role: "",
    skills: [],
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between relative">
          <div className="flex items-center flex-1">
            ...
            <div
              className={`h-0.5 flex-1 mx-2 ${formStep >= 2 ? "bg-indigo-600" : "bg-gray-200"}`}
            ></div>
          </div>
          ...
          <div className="flex items-center flex-1">
            ...
            <div
              className={`h-0.5 flex-1 mx-2 ${formStep >= 3 ? "bg-indigo-600" : "bg-gray-200"}`}
            ></div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          {formStep === 1 && (
            <div className="space-y-6">
              <h2 className="text-lg font-medium text-gray-900 border-b pb-3">
                Basic Information
              </h2>
          ...
          {formStep === 3 && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Optional notes about special considerations, preferences, or
                  other information.
                </p>
              </div>
