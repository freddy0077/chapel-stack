...
export default function AnnouncementsWidget({ widget }: AnnouncementsWidgetProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      <div className="p-4 border-b border-gray-200">
        <h3 className="text-lg font-medium text-gray-800">{widget.title || "Announcements"}</h3>
      </div>
      <div className="p-4">
