    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow sm:rounded-lg overflow-hidden">
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="mt-2 max-w-xl text-sm text-gray-500">
            <p>
              Configure which media categories are shared with your website.
            </p>
          </div>
        </div>
      ...
      <div className="bg-white shadow sm:rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="mt-2 max-w-xl text-sm text-gray-500">
            <p>
              Use this HTML code to embed an upload widget on your website that
              allows visitors to submit photos directly to your media library.
            </p>
          </div>
          <div className="mt-5">
            <textarea
          ...
          <div className="mt-4 flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>
                  All uploaded media from visitors will require approval before
                  being published if you enable the upload widget.
                </p>
              </div>
            </div>
          </div>
