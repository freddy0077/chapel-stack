                      ...
                      <TabPanel>
                        <div className="space-y-6 mt-6">
                          <div className="flex justify-between items-center mb-4">
                            ...
                            <Button size="xs">New Reminder</Button>
                          </div>
                            ...
                            <div className="flex">
                              ...
                              <div className="ml-3">
                                ...
                                <div className="mt-2 text-sm text-yellow-700">
                                  <p>
                                    Sends a reminder email every Monday at 9:00
                                    AM
                                  </p>
                                  <p className="mt-1">
                                    "Don't forget our Bible study tomorrow at
                                    7:00 PM!"
                                  </p>
                                </div>
                                <div className="mt-3">
                            ...
                            <div className="flex">
                              ...
                              <div className="ml-3">
                                ...
                                <div className="mt-2 text-sm text-indigo-700">
                                  ...
                                  <p className="mt-1">
                                    "Reminder about our special guest speaker
                                    this week!"
                                  </p>
                                </div>
                                <div className="mt-3">
                        ...
                        <div className="flex flex-col space-y-4 mt-6">
                          <div className="text-center py-12">
                            ...
                            <p className="mt-1 text-gray-500 max-w-md mx-auto">
                              This feature allows ongoing conversations between
                              group members. All members can participate in the
                              discussion.
                            </p>
                            <div className="mt-6">
