    ...
    <ul className="space-y-4">
      {groups.map((group) => (
        ...
        >
          {/* Status badge */}
          <span
            className={`absolute top-4 right-4 md:static md:ml-auto inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ring-1 ring-inset ${
              group.status === "ACTIVE"
              ...
              <span className="flex items-center gap-1">
                ...
                <span>
                  {group.meetingSchedule ? (
                    ...
                    <span className="italic text-gray-300">No schedule</span>
                  )}
                </span>
              </span>
              <span className="flex items-center gap-1">
