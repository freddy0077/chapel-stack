...
import { XMarkIcon, UserPlusIcon, CalendarIcon, MapPinIcon } from '@heroicons/react/24/outline';
...
export default function GroupDetailsModal({ isOpen, onClose, group }: GroupDetailsModalProps) {
