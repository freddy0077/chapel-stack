          ...
          <Card key={index} className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <div className={`p-3 rounded-xl bg-gradient-to-br ${metric.color === 'text-green-600' ? 'from-green-100 to-green-200' : 
      ...
      <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              { name: 'Monthly Financial Summary', type: 'Financial', date: '2 hours ago', status: 'Ready' },
              { name: 'Member Growth Analysis', type: 'Membership', date: '1 day ago', status: 'Ready' },
              { name: 'Attendance Trends Q4', type: 'Attendance', date: '3 days ago', status: 'Ready' },
              { name: 'Budget vs Actual Report', type: 'Financial', date: '1 week ago', status: 'Ready' }
            ].map((report, index) => (
              <div key={index} className="flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors duration-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 mt-1">GHS 125,430</p>
                      <div className="flex items-center mt-2">
                        <ArrowTrendingUpIcon className="h-4 w-4 text-green-500 mr-1" />
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 mt-1">-GHS 2,340</p>
                      <div className="flex items-center mt-2">
                        <span className="text-sm font-medium text-orange-600">-3.8%</span>
                        <span className="text-sm text-gray-500 ml-1">under budget</span>
                      </div>
                    </div>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Pledge Fulfillment</p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 mt-1">89.3%</p>
                      <div className="flex items-center mt-2">
                        <ArrowTrendingUpIcon className="h-4 w-4 text-green-500 mr-1" />
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  Attendance tracking and analysis features are under development. 
                  You'll be able to track service attendance, event participation, and member engagement patterns.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  ...
                  with drag-and-drop functionality, custom filters, and advanced analytics.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-gray-200">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="fund-select" className="text-sm font-medium text-gray-700 mb-2 block">
                  Fund
                </Label>
          ...
          <div className="flex-1 p-6">
            <h3 className="text-sm font-semibold text-gray-900 mb-4">Report Categories</h3>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">
                    {reportCategories.find(cat => cat.id === activeSection)?.name || 'Reports'}
                  </h1>
                  <p className="text-gray-600">
                    {reportCategories.find(cat => cat.id === activeSection)?.description || 'Analytics and insights'}
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
