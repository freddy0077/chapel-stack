...
export default function DeviceManagement() {
  ...
  const [newDeviceType, setNewDeviceType] = useState<'wall-mounted' | 'kiosk' | 'admin' | 'mobile'>('wall-mounted');
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800">Card Scanning Device Management</h2>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        {filteredDevices.map(device => (
          <div key={device.id} className="border border-gray-300 rounded-lg overflow-hidden shadow-sm">
            <div className="p-4 bg-gray-50 border-b border-gray-300 flex justify-between items-center">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-semibold text-gray-800">{device.name}</h3>
                  <p className="text-xs text-gray-500">{getDeviceTypeName(device.deviceType)}</p>
                </div>
              </div>
              <div>
            ...
            <div className="p-4">
              <div className="grid grid-cols-2 gap-2 text-sm mb-4">
                <div>
                  ...
                  <span className="ml-1 text-gray-800">{device.locationId}</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="ml-1 text-gray-800">{device.ipAddress || 'N/A'}</span>
                </div>
                <div className="flex items-center">
                ...
                <div>
                  ...
                  <span className="ml-1 text-gray-800">{device.firmwareVersion}</span>
                </div>
                {device.batteryLevel !== undefined && (
                  <div className="flex items-center">
                    <span className="text-gray-500">Battery:</span> 
                    <BoltIcon className={`h-4 w-4 ml-1 ${getBatteryStatusClass(device.batteryLevel)}`} />
                    <span className={`ml-1 ${getBatteryStatusClass(device.batteryLevel)}`}>
                      {device.batteryLevel}%
                    </span>
                  </div>
                )}
              ...
              <div className="mt-2 border-t border-gray-200 pt-3">
                <div className="text-sm">
                  ...
                  <span className="ml-1 text-gray-800">{getAssignedEventName(device.id)}</span>
                </div>
                <div className="text-sm">
              ...
              <div className="mt-4 flex justify-between">
                ...
                <div className="space-x-2">
                  {device.status === 'online' ? (
                    ...
                    <button
                      onClick={() => handleDeviceStatusChange(device.id, 'online')}
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Offline Devices</dt>
                  <dd className="flex items-baseline">
                    <div className="text-2xl font-semibold text-gray-900">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Maintenance Mode</dt>
                  <dd className="flex items-baseline">
                    <div className="text-2xl font-semibold text-gray-900">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Low Battery</dt>
                  <dd className="flex items-baseline">
                    <div className="text-2xl font-semibold text-gray-900">
                      {devices.filter(
          ...
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <div className="mb-4">
              ...
              <select
                ...
                className="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                value={newDeviceType}
                onChange={(e) => setNewDeviceType(e.target.value as 'wall-mounted' | 'kiosk' | 'admin' | 'mobile')}
              >
            ...
            <div className="mb-6">
              <label htmlFor="device-branch" className="block text-sm font-medium text-gray-700 mb-1">
                Branch
              </label>
              <select
                id="device-branch"
      ...
      {isAssignEventModalOpen && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Assign Device to Event</h3>
