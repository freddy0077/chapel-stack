          ...
          <div className="mt-4 space-y-4">
            <div className="bg-blue-50 p-4 rounded-md">
              ...
              <Text className="text-sm text-gray-600">
                The Main Campus has seen a 5.2% increase in membership
                year-over-year, with the highest growth among young
                professionals in the 26-35 age range.
              </Text>
            </div>
            ...
            <div className="bg-green-50 p-4 rounded-md">
              ...
              <Text className="text-sm text-gray-600">
                The East Side branch is experiencing the fastest growth at 8.3%
                YoY, likely due to the new family-focused programs introduced in
                Q1 2025.
              </Text>
            </div>
            ...
            <div className="bg-amber-50 p-4 rounded-md">
              ...
              <Text className="text-sm text-gray-600">
                While the West End branch is growing at 3.5% YoY, it has the
                lowest retention rate. The data suggests investment in more
                diverse programming may help improve retention.
              </Text>
            </div>
            ...
            <div className="bg-rose-50 p-4 rounded-md">
              ...
              <Text className="text-sm text-gray-600">
                The South Chapel has seen a 12.6% increase in youth membership
                (ages 13-18), the highest youth growth rate across all branches,
                attributed to their revamped youth ministry program.
              </Text>
            </div>
          </div>
        </Card>
