...
const migrationSummary = [
  { title: "Total Migrations", value: "97", change: "+12.8% from last quarter", color: "indigo" },
  { title: "Net Branch Changes", value: "53", change: "+8.5% from last quarter", color: "emerald" },
  { title: "Average Distance", value: "8.3 mi", change: "-2.1 from last quarter", color: "amber" },
  { title: "Most Common Reason", value: "Relocated", change: "44% of all migrations", color: "rose" }
];
    ...
    <div className="p-6">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Member Migration Patterns</h1>
        ...
        <div className="mt-4 sm:mt-0 flex space-x-3">
          ...
          <button
            ...
            className="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
            <DocumentChartBarIcon className="-ml-1 mr-2 h-5 w-5 text-gray-500" aria-hidden="true" />
            Generate PDF
          </button>
        </div>
      </div>
      ...
      <div className="mt-8">
        <Card>
          ...
          <div className="mt-4 flex justify-center">
            <Link href="/dashboard/analytics/migration/history" className="text-sm text-indigo-600 hover:text-indigo-800">
        ...
        <Card>
          <div className="sm:flex sm:items-center sm:justify-between">
            <div>
              ...
              <Subtitle>Geographical factors affecting member migrations</Subtitle>
            </div>
          ...
          <div className="mt-4 space-y-4">
            <div className="bg-blue-50 p-4 rounded-md">
              ...
              <Text className="text-sm text-gray-600">
                44% of all branch migrations are due to members relocating, with most movement occurring between 
                Main Campus and East Side (urban to suburban transition). Consider strategic branch placement to 
            ...
            <div className="bg-green-50 p-4 rounded-md">
              ...
              <Text className="text-sm text-gray-600">
                Members who travel more than 15 miles to attend service are 3.2x more likely to switch to a 
                closer branch within 6 months. The average commute distance for stable members is 8.3 miles, 
            ...
            <div className="bg-amber-50 p-4 rounded-md">
              ...
              <Text className="text-sm text-gray-600">
                Analysis of migration patterns reveals three high-potential areas for new branch development:
                North Ridge (12 miles from Main Campus), Westlake District (18 miles from West End), and 
      ...
      <div className="mt-8">
        <Card className="bg-indigo-50">
          <Flex justifyContent="between" alignItems="center">
            <div>
              <Title className="text-indigo-900">Migration Experience Survey</Title>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="bg-white p-4 rounded-md">
                ...
                <div className="flex items-center mt-2">
                  <span className="text-3xl font-bold text-indigo-700">86%</span>
                  <span className="ml-2 text-sm text-gray-600">reported a smooth transition between branches</span>
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-md">
                ...
                <div className="flex items-center mt-2">
                  <span className="text-3xl font-bold text-indigo-700">62%</span>
                  <span className="ml-2 text-sm text-gray-600">reported improved engagement after changing branches</span>
                </div>
              </div>
            </div>
