...
const mockResources = [
  {
    ...
    format: "docx",
    thumbnail:
      "https://placehold.co/400x300/indigo/white?text=Baptism+Template",
  ...
  },
  {
    ...
    format: "xlsx",
    thumbnail:
      "https://placehold.co/400x300/amber/white?text=Financial+Template",
    uploadedBy: "Diocese Administration",
  ...
  },
  {
    ...
    format: "pdf",
    thumbnail:
      "https://placehold.co/400x300/rose/white?text=Communion+Guidelines",
                      ...
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center">
                          ...
                          {resource.format === "xlsx" && (
                            <DocumentIcon className="h-8 w-8 text-green-500 mr-3" />
                          )}
                          {resource.format === "zip" && (
            ...
            <div className="bg-white dark:bg-gray-800 overflow-hidden rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
              <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                  Pending Resource Sharing Requests
                </h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <div className="flex justify-end space-x-2">
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  alert(
                                    `Reject request for ${request.resourceName}`,
                                  );
                                }}
                              >
                                Reject
                              ...
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  alert(
                                    `Approve request for ${request.resourceName}`,
                                  );
                                }}
                              >
                                Approve
          ...
          <div className="p-4 border border-gray-100 dark:border-gray-700 rounded-lg">
            ...
            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
              <li className="flex items-start">
                ...
                <span>
                  Ensure all shared resources comply with copyright laws and
                  diocesan guidelines.
                </span>
              </li>
              <li className="flex items-start">
                <span className="inline-block h-1.5 w-1.5 rounded-full bg-indigo-500 mt-1.5 mr-2"></span>
                <span>
                  Use descriptive file names and include relevant metadata for
                  searchability.
                </span>
              </li>
              <li className="flex items-start">
                <span className="inline-block h-1.5 w-1.5 rounded-full bg-indigo-500 mt-1.5 mr-2"></span>
                <span>
                  Consider the appropriate sharing level (diocesan, regional, or
                  branch-specific).
                </span>
              </li>
            </ul>
          ...
          <div className="p-4 border border-gray-100 dark:border-gray-700 rounded-lg">
            ...
            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
              <li className="flex items-start">
                ...
                <span>
                  Branch-level resources: Approved by branch administrators
                </span>
              </li>
              <li className="flex items-start">
                <span className="inline-block h-1.5 w-1.5 rounded-full bg-green-500 mt-1.5 mr-2"></span>
              ...
              <li className="flex items-start">
                <span className="inline-block h-1.5 w-1.5 rounded-full bg-green-500 mt-1.5 mr-2"></span>
                <span>
                  Diocesan resources: Approved by diocesan administrators
                </span>
              </li>
            </ul>
          </div>
