...
export default function SecurityAdministration() {
  ...
  const tabs = [
    ...
    { name: 'Roles & Permissions', icon: KeyIcon, component: RolePermissionManager },
    { name: 'Data Sharing', icon: DocumentDuplicateIcon, component: DataSharingPolicies },
    { name: 'Audit Logs', icon: ClipboardDocumentListIcon, component: AuditLogs }
  ];
        ...
        <div className="flex">
          ...
          <div className="ml-3 flex-1 md:flex md:justify-between">
            <p className="text-sm text-blue-700">
              Review our security guidelines and compliance recommendations for multi-branch church systems.
            </p>
