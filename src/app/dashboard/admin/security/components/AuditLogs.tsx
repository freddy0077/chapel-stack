...
export default function AuditLogs() {
  ...
  const [selectedEvent, setSelectedEvent] = useState<UserAuditEvent | null>(null);
  ...
  const filteredLogs = logs.filter(log => {
    ...
    if (filters.branch !== 'all' && log.branchId !== filters.branch) return false;
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                        log.action === 'view_sensitive' || log.action === 'delete' 
                          ? 'bg-red-100 text-red-800' 
                          : log.action === 'login' || log.action === 'logout' 
                          ? 'bg-blue-100 text-blue-800'
                          : log.action === 'grant_access' || log.action === 'revoke_access'
        ...
        <div className="w-full lg:w-1/3 p-4">
          {selectedEvent ? (
            <div>
              ...
              <div className="bg-gray-50 p-4 rounded mb-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{getUserName(selectedEvent.userId)}</p>
                  </div>
                  <div>
              ...
              <div className="bg-gray-50 p-4 rounded mb-4">
                <h5 className="text-sm font-medium text-gray-700 mb-2">Action Information</h5>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900">
                      {selectedEvent.branchId ? getBranchName(selectedEvent.branchId) : 'Organization-wide'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded">
                <h5 className="text-sm font-medium text-gray-700 mb-2">Additional Metadata</h5>
                {Object.keys(selectedEvent.metadata).length > 0 ? (
                  ...
                  <p className="text-sm text-gray-500">No additional metadata</p>
                )}
              </div>
            </div>
          ) : (
            <div className="flex flex-col items-center justify-center h-full py-12">
              ...
              <p className="mt-2 text-sm text-gray-500">Select an event to view details</p>
            </div>
          )}
        </div>
      </div>
