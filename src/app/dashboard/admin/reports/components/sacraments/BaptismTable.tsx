  ...
  return (
    <div className="p-4 overflow-x-auto">
      <div className="flex justify-between items-center mb-4">
        <div>
          <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Monthly Statistics</h3>
          <p className="text-xs text-gray-500 dark:text-gray-400">Baptism records by month and age group</p>
        </div>
      ...
      <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <tfoot className="bg-gray-50 dark:bg-gray-750">
          <tr>
            ...
            <td className="px-2 py-4 whitespace-nowrap text-sm text-center font-medium text-gray-900 dark:text-white">
              {branchesToDisplay.reduce((total, branch) => total + calculateTotalBaptisms(branch), 0)}
            </td>
            <td className="px-2 py-4 whitespace-nowrap text-sm text-center font-medium text-gray-900 dark:text-white">
              {branchesToDisplay.reduce((total, branch) => total + calculateTotalChildBaptisms(branch), 0)}
            </td>
            <td className="px-2 py-4 whitespace-nowrap text-sm text-center font-medium text-gray-900 dark:text-white">
              {branchesToDisplay.reduce((total, branch) => total + calculateTotalAdultBaptisms(branch), 0)}
            </td>
          </tr>
        </tfoot>
      </table>
      ...
      <div className="mt-6">
        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Insights</h3>
