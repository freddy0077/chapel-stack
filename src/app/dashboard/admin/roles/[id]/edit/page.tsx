...
export default function EditRolePage() {
  ...
  useEffect(() => {
    ...
    if (roleData) {
      ...
      if (roleData.branches)
        setSelectedBranches(
          mockBranches
            .filter((b) => roleData.branches?.includes(b.name))
            .map((b) => b.id),
        );
    }
    setLoading(false);
  ...
  const handleSelectAllInCategory = (category: string) => {
    const categoryPermissions =
      permissionGroups.find((group) => group.category === category)
        ?.permissions || [];
        ...
        <div className="p-6">
                  ...
                  >
                    <div className="flex items-center justify-between bg-gray-50 dark:bg-gray-750 px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          handleSelectAllInCategory(group.category)
                        }
          ...
          <div className="mt-8 flex items-center justify-end space-x-4">
            ...
            <button
              ...
              disabled={
                !roleName || !accessLevel || selectedPermissions.length === 0
              }
