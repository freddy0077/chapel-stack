...
const mockRoles: Role[] = [
  ...
  },
  {
    ...
    description:
      "Manages baptism, communion, confirmation, and marriage records",
    accessLevel: "branch",
    permissions: 8,
    ...
    <div className="container mx-auto px-4 py-8">
      <header className="mb-8">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
          Create and manage administrative roles with branch-specific access
          controls
        </p>
      </header>
            ...
            >
              <div className="px-6 py-5 flex justify-between items-start">
                <div className="flex items-start">
                  <div
                    className={`rounded-lg p-3 ${getAccessLevelStyles(role.accessLevel)} mr-4`}
                  >
                  ...
                  <div>
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2">
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getAccessLevelStyles(role.accessLevel)}`}
                      >
                        {role.accessLevel === "diocese"
                          ? "Diocese-Level"
                          : role.accessLevel === "regional"
                            ? "Regional-Level"
                            : "Branch-Level"}
                      </span>
