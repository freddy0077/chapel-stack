...
export default function CommunionRecordsPage() {
  ...
  const { records, loading, error, refetch } = useFilteredCommunionRecords(orgBranchFilter);
  ...
  const filteredRecords = records.filter(record => {
    ...
    const matchesDate = !dateFilter || 
      record.communionDate?.includes(dateFilter);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm border border-amber-100 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Total Communions</p>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">
                  {records.filter(r => r.communionDate?.includes(new Date().getFullYear().toString())).length}
                </p>
              </div>
            </div>
          </div>
        ...
        {filteredRecords.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Communion Records Found</h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-amber-100 text-sm">First Communion</p>
                      </div>
                    </div>
