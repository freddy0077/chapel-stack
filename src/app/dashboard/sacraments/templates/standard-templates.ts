...
export const STANDARD_TEMPLATES: StandardCertificateTemplate[] = [
  // ==================== CATHOLIC TEMPLATES ====================
  {
    ...
    description:
      "Traditional Catholic baptism certificate with Latin elements and papal seal",
    ...
    liturgicalElements: [
      ...
      },
      {
        type: "PRAYER",
        content:
          "Almighty and eternal God, you have regenerated this your servant by water and the Holy Spirit...",
        position: "FOOTER",
        optional: true,
      },
    ],
...

  {
    ...
    description:
      "Classic Catholic First Communion certificate with Eucharistic symbols",
    ...
    liturgicalElements: [
      {
        type: "SCRIPTURE",
        content:
          "Take and eat, this is my body which is given for you. - Luke 22:19",
        position: "HEADER",
        optional: false,
      },
    ],
  ...
  // ==================== ANGLICAN/EPISCOPAL TEMPLATES ====================
  {
    ...
    sacramentType: "BAPTISM",
    description:
      "Traditional Anglican baptism certificate following Book of Common Prayer",
  ...
  // ==================== LUTHERAN TEMPLATES ====================
  {
    ...
    sacramentType: "BAPTISM",
    description:
      "Lutheran baptism certificate with Reformation heritage design",
  ...
  // ==================== BAPTIST TEMPLATES ====================
  {
    ...
    description:
      "Baptist immersion baptism certificate emphasizing believer's baptism",
  ...
  // ==================== METHODIST TEMPLATES ====================
  {
    ...
    sacramentType: "BAPTISM",
    description:
      "Methodist baptism certificate with Wesleyan tradition elements",
  ...
  // ==================== PENTECOSTAL TEMPLATES ====================
  {
    ...
    liturgicalElements: [
      ...
      },
      {
        type: "PRAYER",
        content:
          "Holy Spirit, fill this believer with your power and presence...",
        position: "BODY",
        optional: false,
      },
    ],
  ...
  // ==================== NONDENOMINATIONAL TEMPLATES ====================
  {
    ...
    sacramentType: "BAPTISM",
    description:
      "Clean, simple baptism certificate for nondenominational churches",
...

  {
    ...
    sacramentType: "MATRIMONY",
    description:
      "Modern Protestant wedding certificate with contemporary design",
...
export const getTemplatesByDenomination = (
  denomination: ChurchDenomination,
): StandardCertificateTemplate[] => {
  return STANDARD_TEMPLATES.filter(
    (template) => template.denomination === denomination,
  );
};

export const getTemplatesBySacrament = (
  sacramentType: SacramentType,
): StandardCertificateTemplate[] => {
  return STANDARD_TEMPLATES.filter(
    (template) => template.sacramentType === sacramentType,
  );
};
...
export const getDefaultTemplate = (
  denomination: ChurchDenomination,
  sacramentType: SacramentType,
): StandardCertificateTemplate | null => {
  return (
    STANDARD_TEMPLATES.find(
      (template) =>
...
export const getAllDenominations = (): ChurchDenomination[] => {
  return Array.from(
    new Set(STANDARD_TEMPLATES.map((template) => template.denomination)),
  );
};

export const getAllSacramentTypes = (): SacramentType[] => {
  return Array.from(
    new Set(STANDARD_TEMPLATES.map((template) => template.sacramentType)),
  );
};
...
export const customizeTemplateForBranch = (
  ...
  return {
    ...
    styling: {
      ...
      secondaryColor:
        branchInfo.secondaryColor || template.styling.secondaryColor,
    },
    customFields: [
