...
const mockTemplates: CertificateTemplate[] = [
  { id: "t1", name: "Classic", type: "baptism", previewImageUrl: "/images/certificate-templates/baptism-classic.jpg" },
  { id: "t2", name: "Modern", type: "baptism", previewImageUrl: "/images/certificate-templates/baptism-modern.jpg" },
  { id: "t3", name: "Classic", type: "communion", previewImageUrl: "/images/certificate-templates/communion-classic.jpg" },
  { id: "t4", name: "Modern", type: "communion", previewImageUrl: "/images/certificate-templates/communion-modern.jpg" },
  { id: "t5", name: "Classic", type: "confirmation", previewImageUrl: "/images/certificate-templates/confirmation-classic.jpg" },
  { id: "t6", name: "Modern", type: "confirmation", previewImageUrl: "/images/certificate-templates/confirmation-modern.jpg" },
  { id: "t7", name: "Classic", type: "marriage", previewImageUrl: "/images/certificate-templates/marriage-classic.jpg" },
  { id: "t8", name: "Modern", type: "marriage", previewImageUrl: "/images/certificate-templates/marriage-modern.jpg" }
];
...
const CertificateGenerator: React.FC<CertificateGeneratorProps> = ({
  ...
  const getCertificateTitle = () => {
    switch (certificateData.type) {
      case "baptism": return "Certificate of Baptism";
      case "communion": return "Certificate of First Holy Communion";
      case "confirmation": return "Certificate of Confirmation";
      case "marriage": return "Certificate of Holy Matrimony";
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:p-6">
                    ...
                    <ol role="list" className="space-y-4 md:flex md:space-y-0 md:space-x-8">
                      <li className="md:flex-1">
                        ...
                        >
                          ...
                          <span className="text-sm font-medium">Select Branch Letterhead</span>
                        </div>
                      </li>
                      <li className="md:flex-1">
                        <div
                        ...
                        >
                          ...
                          <span className="text-sm font-medium">Choose Certificate Style</span>
                        </div>
                      </li>
                      <li className="md:flex-1">
                        <div
                ...
                <div className="mt-8">
                  ...
                  {step === 1 && (
                    <div>
                      <h4 className="text-sm font-medium text-gray-900">Select Branch Letterhead</h4>
                          ...
                          >
                            ...
                            <div className="flex items-center">
                              ...
                              <div className="ml-4 text-left">
                                ...
                                <p className="mt-1 text-xs text-gray-500">{branch.location}</p>
                              </div>
                            </div>
                            <div className="mt-2 text-xs text-gray-500">
                              Using {branch.name} letterhead with your branch styling
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  {step === 2 && (
                    <div>
                      <h4 className="text-sm font-medium text-gray-900">Choose Certificate Template</h4>
                      <p className="mt-1 text-sm text-gray-500">
                        Select a template for your {getCertificateTitle().toLowerCase()}
                      </p>
                        ...
                        {relevantTemplates.map((template) => (
                          ...
                          >
                            ...
                            <div className="flex items-center justify-center p-2 bg-gray-50 rounded-md">
                              ...
                              <DocumentTextIcon className="h-32 w-32 text-gray-400" aria-hidden="true" />
                            </div>
                            <div className="mt-2 text-center">
                              <h3 className="text-sm font-medium text-gray-900">{template.name}</h3>
                              <p className="mt-1 text-xs text-gray-500">
                                {template.type.charAt(0).toUpperCase() + template.type.slice(1)} Style
                              </p>
                            </div>
                          </div>
                        ))}
                  ...
                  {step === 3 && (
                    <div>
                      <h4 className="text-sm font-medium text-gray-900">Certificate Generated</h4>
                      <p className="mt-1 text-sm text-gray-500">
                      ...
                      <div className="mt-4 rounded-lg border border-gray-300 bg-white p-4 shadow-sm">
                        <div className="flex flex-col items-center justify-center">
                          <div className="bg-gray-50 w-full rounded-t-md p-4 text-center border-b border-gray-200" style={{
                          ...
                          <div className="w-full p-6 text-center">
                            <h1 className="text-2xl font-bold mb-4">{getCertificateTitle()}</h1>
                            ...
                            <p className="text-lg mb-6">
                              {certificateData.type === "baptism" && "was baptized on"}
                              {certificateData.type === "communion" && "received First Holy Communion on"}
                              {certificateData.type === "confirmation" && "was confirmed on"}
                            ...
                            {certificateData.recordNumber && (
                              <p className="text-xs text-gray-500 mt-8">Certificate #: {certificateData.recordNumber}</p>
                            )}
                          </div>
                          
                          <div className="bg-gray-50 w-full rounded-b-md p-2 text-center text-xs border-t border-gray-200" style={{
                            backgroundColor: selectedBranch?.secondaryColor,
                            color: 'white'
                          }}>
                            {selectedBranch?.contactInfo} | {selectedBranch?.website}
                          </div>
                        </div>
                      </div>
