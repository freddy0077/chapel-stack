    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        <DashboardHeader
          ...
          subtitle="Sacred initiation into the Christian faith"
          icon={SparklesIcon}
          action={{
            label: "New Baptism",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-center py-12">
            <div className="flex flex-col items-center space-y-4">
              <SparklesIconSolid className="h-8 w-8 text-blue-500 animate-spin" />
              <p className="text-gray-600">Loading baptism records...</p>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100 text-sm">Baptism Record</p>
                      </div>
                    </div>
                    {record.baptismDate && (
