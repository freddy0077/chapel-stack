      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative">
        ...
        <div className="flex gap-3 mt-8">
          <button
            ...
            className="flex-1 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-400 py-2 text-white font-semibold shadow-lg hover:from-indigo-600 hover:to-purple-500 transition"
          >
            Add Budget
          </button>
          <button
