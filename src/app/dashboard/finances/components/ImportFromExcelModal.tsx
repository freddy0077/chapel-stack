  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative">
        ...
        <h2 className="text-xl font-bold text-indigo-900 mb-6">Import Contributions from Excel</h2>
        <div className="mb-4 text-sm text-indigo-700 bg-indigo-50 rounded-lg p-3">
          <p>Upload a .xlsx or .csv file. Make sure your columns match the template. Only new contributions will be imported.</p>
        </div>
        <form className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-indigo-500 mb-1">Select File</label>
            <input
              type="file"
              accept=".xlsx,.csv"
