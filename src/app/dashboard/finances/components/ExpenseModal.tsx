      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-8 relative">
        ...
        <form id="expense-form" className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <select
              className="rounded-xl border border-rose-100 px-3 py-2 w-full bg-white/90 shadow focus:ring-2 focus:ring-rose-300"
              value={category}
        ...
        <div className="flex gap-3 mt-8">
          <button
            ...
            form="expense-form"
            disabled={loading}
            className="flex-1 rounded-xl bg-gradient-to-br from-rose-500 to-pink-400 py-2 text-white font-semibold shadow-lg hover:from-rose-600 hover:to-pink-500 transition disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={loading}
            onClick={onClose}
            className="flex-1 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 py-2 text-white font-semibold shadow-lg hover:from-indigo-600 hover:to-purple-600 transition disabled:opacity-50"
          >
            Cancel
          </button>
        </div>
