      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              type="text"
              className="rounded-xl border border-blue-100 px-3 py-2 w-full bg-white/90 shadow focus:ring-2 focus:ring-blue-300"
        ...
        <div className="flex gap-3 mt-8">
          <button
            ...
            className="flex-1 rounded-xl bg-gradient-to-br from-blue-500 to-sky-400 py-2 text-white font-semibold shadow-lg hover:from-blue-600 hover:to-sky-500 transition"
          >
            Add Account
          </button>
          <button
