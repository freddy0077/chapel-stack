...
export default function VolunteerScheduling() {
  ...
  const [selectedAssignmentStatus, setSelectedAssignmentStatus] =
    useState<string>("all");
  const [showAvailableVolunteersFor, setShowAvailableVolunteersFor] = useState<
    string | null
  >(null);
  ...
  const filteredAssignments = mockAssignments.filter((assignment) => {
    ...
    if (
      ...
      assignment.status !== selectedAssignmentStatus
    ) {
      return false;
    }
  ...
  const assignmentsByEvent = filteredAssignments.reduce(
    (acc, assignment) => {
  ...
  const availableVolunteers = showAvailableVolunteersFor
    ? getAvailableVolunteers(
        filteredAssignments.find((a) => a.id === showAvailableVolunteersFor)
          ?.date || "",
        filteredAssignments.find((a) => a.id === showAvailableVolunteersFor)
          ?.branchId || "",
      )
    ...
    <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-12">
      <div className="sm:flex sm:items-center mb-6">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            Schedule and manage volunteers for events across all church
            branches.
          </p>
        </div>
      ...
      <div className="space-y-6">
        {Object.values(assignmentsByEvent).map((eventGroup) => (
          <div
            key={`${eventGroup.eventId}-${eventGroup.date}`}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <Link
                          href={`/dashboard/calendar/volunteers/contact/${assignment.volunteerId}`}
                        >
                          <button
                            type="button"
                              ...
                              <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                  ...
                                  <div className="flex text-xs text-gray-500 space-x-2">
                                    ...
                                    <span>•</span>
                                    <span>
                                      {volunteer.assignedEvents} events
                                    </span>
                                  </div>
                                </div>
                              </div>
              ...
              <li key={volunteer.id} className="px-6 py-5">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex space-x-2">
                      <Link
                        href={`/dashboard/calendar/volunteers/${volunteer.id}`}
                      >
                        <button
                          type="button"
                      ...
                      <Link
                        href={`/dashboard/calendar/volunteers/schedule/${volunteer.id}`}
                      >
                        <button
                          type="button"
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  {volunteer.preferredBranches.map((branchId) => (
                    ...
                    >
                      {mockBranches.find((b) => b.id === branchId)?.name ||
                        branchId}
                    </span>
                  ))}
                </div>
