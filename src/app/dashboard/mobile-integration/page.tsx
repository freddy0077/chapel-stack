...
export default function MobileIntegration() {
  ...
  const handleForceSync = (deviceId: string) => {
    ...
    setTimeout(() => {
      setDevices(
        devices.map((device) =>
          device.id === deviceId
            ? { ...device, status: "synced", lastSync: new Date() }
            : device,
        ),
      );
    }, 3000);
  ...
  const handleRevokeAccess = (deviceId: string) => {
    if (
      confirm(
        "Are you sure you want to revoke access for this device? The user will need to re-authenticate.",
      )
    ) {
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  {devices.filter((d) => d.status === "synced").length} of{" "}
                  {devices.length} devices synced
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-4 flex justify-center">
                    {isGeneratingQR ? (
                      <div
                        className="p-4 bg-white border border-gray-200 rounded-lg flex items-center justify-center"
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-500">
                      This QR code will expire in 10 minutes for security
                      reasons. Scan it with your church mobile app to instantly
                      connect the device.
                    </p>
                  </div>
                </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">
                      {formatDate(selectedDevice.lastSync)}
                    </p>
                  </div>
      ...
      <div className="mt-8 bg-white overflow-hidden shadow rounded-lg">
        <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Overview of data synchronization between mobile devices and the main
            system
          </p>
        </div>
        <div className="p-6">
