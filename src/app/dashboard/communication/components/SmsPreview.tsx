...
export default function SmsPreview({
  ...
  const plainTextBody = resolveCustomPlaceholders(
    frontendResolved,
    customPlaceholders,
  );
      ...
      <div className="mb-3 space-y-3">
        ...
        <div className="flex items-center justify-between text-sm">
          <div>
            ...
            <span
              className={
                smsSegmentInfo.count > 3
                  ? "text-red-500 font-medium"
                  : "text-gray-600 font-medium"
              }
            >
              {smsSegmentInfo.count} segment
              {smsSegmentInfo.count !== 1 ? "s" : ""}
            </span>
            <span className="text-gray-500 mx-1">•</span>
        ...
        <div>
          <Progress
            value={
              (smsSegmentInfo.total /
                (smsSegmentInfo.count * SMS_CHAR_LIMIT_MULTI)) *
              100
            }
      ...
      <div className="mt-6">
        ...
        <div className="border rounded-2xl bg-gray-100 p-6 max-w-xs mx-auto">
          <div className="bg-white rounded-2xl p-4 shadow-md border border-gray-300">
            ...
            <div className="text-xs text-gray-400 text-right mt-1">Now</div>
          </div>
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-gray-600">
              ...
              <span className="text-gray-500">
                {" "}
                ({smsSegmentInfo.count} segments ×{" "}
                {getTotalRecipientCount() || 1} recipients)
              </span>
            </p>
          </div>
        </div>
