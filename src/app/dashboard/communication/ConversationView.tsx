...
const MOCK_MESSAGES = [
  {
    ...
    time: "2025-07-14 09:00",
    self: false,
  },
  { from: "You", message: "Thank you!", time: "2025-07-14 09:05", self: true },
  {
    from: "Admin",
    message: "We hope to see you at the next service.",
    time: "2025-07-14 09:10",
    self: false,
  },
];
    ...
    <div className="max-w-2xl mx-auto p-6 space-y-4">
      ...
      <Card className="p-6 space-y-4">
        {MOCK_MESSAGES.map((msg, idx) => (
          ...
          >
            <div
              className={`rounded-lg px-4 py-2 shadow ${msg.self ? "bg-violet-100 text-violet-900" : "bg-gray-100 text-gray-700"}`}
            >
