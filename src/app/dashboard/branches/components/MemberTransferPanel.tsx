...
export default function MemberTransferPanel({
  branchId,
  branchName,
}: MemberTransferPanelProps) {
            ...
            {transferRequests.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  There are no{" "}
                  {activeTab === "incoming" ? "incoming" : "outgoing"} transfer
                  requests for {branchName} at this time.
                </p>
                <div className="mt-6">
                  <button
                      ...
                      <div className="flex items-center">
                              ...
                              <div className="relative flex items-start">
                                <div className="flex h-6 items-center">
                                  <input
                                    ...
                                    onChange={(e) =>
                                      toggleTransferSelection(transfer.id, e)
                                    }
                        ...
                        <div>
                          <h4 className="text-base font-semibold text-gray-900 dark:text-white">
                            <Link
                              href={`/dashboard/members/${transfer.memberId}`}
                    ...
                    <div className="mt-4 text-sm text-gray-500 dark:text-gray-400">
                      <div className="grid grid-cols-1 gap-y-2 sm:grid-cols-2 sm:gap-x-4 bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                        <div className="flex items-start">
                          <span className="font-medium text-gray-700 dark:text-gray-300 min-w-28">
                            Request Date:
                          </span>{" "}
                        ...
                        <div className="sm:col-span-2 flex items-start">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {transfer.transferData.map((item) => (
                              <span
                                key={item}
                                className="capitalize inline-flex items-center rounded-full bg-indigo-100 dark:bg-indigo-900/30 px-2.5 py-0.5 text-xs font-medium text-indigo-800 dark:text-indigo-300"
                              >
                                {item.replace("_", " ")}
                              </span>
                            ))}
                      ...
                      canManageTransfers && (
                        <div className="mt-6 flex justify-end space-x-3">
                          ...
                          <button
                            ...
                            disabled={
                              isProcessing || processingTransfers[transfer.id]
                            }
                            className="inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none disabled:opacity-50"
                          >
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          ...
                          request. This will be visible to the member and the
                          source branch.
                        </p>
                        <div className="mt-4">
                          <label
                ...
                <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Are you sure you want to approve the selected transfer
                          requests?
                        </p>
                      </div>
                    </div>
