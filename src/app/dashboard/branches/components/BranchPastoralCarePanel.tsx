...
const BranchPastoralCarePanel: React.FC<BranchPastoralCarePanelProps> = ({
  branchId,
}) => {
  ...
  } = useQuery(GET_PASTORAL_CARE_DASHBOARD, {
  ...
  const upcomingVisits =
    dashboardData?.pastoralCareDashboard?.upcomingVisits || [];
  const upcomingSessions =
    dashboardData?.pastoralCareDashboard?.upcomingSessions || [];
  const urgentCareRequests =
    dashboardData?.pastoralCareDashboard?.urgentCareRequests || [];
  const dueTodayReminders =
    dashboardData?.pastoralCareDashboard?.dueTodayReminders || [];
  const overdueReminders =
    dashboardData?.pastoralCareDashboard?.overdueReminders || [];
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Manage pastoral visits, counseling, and member care
          </p>
        </div>
