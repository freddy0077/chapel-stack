      ...
      <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="mt-4 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <label htmlFor="allowMemberTransfers" className="text-sm font-medium text-gray-700">
                    Allow Member Transfers
                  </label>
                  <p className="text-xs text-gray-500">
                    Allow members to be transferred between this branch and others
                  </p>
                </div>
                <Switch
                  checked={currentSettings.allowMemberTransfers}
                  onChange={(checked) => handleToggleChange('allowMemberTransfers', checked)}
                  className={classNames(
                    currentSettings.allowMemberTransfers ? 'bg-indigo-600' : 'bg-gray-200',
                ...
                >
                  ...
                  <span
                    aria-hidden="true"
                    className={classNames(
                      currentSettings.allowMemberTransfers ? 'translate-x-5' : 'translate-x-0',
              ...
              <div className="flex items-center justify-between">
                <div>
                  <label htmlFor="allowResourceSharing" className="text-sm font-medium text-gray-700">
                ...
                <Switch
                  ...
                  onChange={(checked) => handleToggleChange('allowResourceSharing', checked)}
                  className={classNames(
                    currentSettings.allowResourceSharing ? 'bg-indigo-600' : 'bg-gray-200',
                    'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
                  )}
                >
                  ...
                  <span
                    aria-hidden="true"
                    className={classNames(
                      currentSettings.allowResourceSharing ? 'translate-x-5' : 'translate-x-0',
                      'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out'
                    )}
                  />
                </Switch>
              ...
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4">
                <label htmlFor="visibilityToOtherBranches" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                  Branch Visibility
                </label>
                <div className="mt-1 sm:col-span-2 sm:mt-0">
                  <select
                    ...
                    onChange={(e) => handleSelectChange('visibilityToOtherBranches', e.target.value as VisibilityLevel)}
                  >
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Controls how much information other branches can see about this branch
                  </p>
                </div>
              </div>
              
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4">
                <label htmlFor="memberDataVisibility" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                ...
                <div className="mt-1 sm:col-span-2 sm:mt-0">
                  <select
                    ...
                    onChange={(e) => handleSelectChange('memberDataVisibility', e.target.value as VisibilityLevel)}
                  >
                    {visibilityOptions.map((option) => (
                      <option key={option.value} value={option.value}>
                        {option.label}
          ...
          <div className="pt-6 border-t border-gray-200">
            ...
            <div className="mt-4 space-y-4">
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4">
                <label htmlFor="financialReportingLevel" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                  Financial Reporting
                </label>
                <div className="mt-1 sm:col-span-2 sm:mt-0">
                  <select
                    ...
                    onChange={(e) => handleSelectChange('financialReportingLevel', e.target.value as ReportingLevel)}
                  >
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Determines how financial data is reported to the diocese/organization
                  </p>
                </div>
              </div>
              
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4">
                <label htmlFor="attendanceReportingLevel" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                ...
                <div className="mt-1 sm:col-span-2 sm:mt-0">
                  <select
                    ...
                    onChange={(e) => handleSelectChange('attendanceReportingLevel', e.target.value as ReportingLevel)}
                  >
                    {reportingOptions.map((option) => (
                      <option key={option.value} value={option.value}>
                        {option.label}
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Controls how attendance data is shared with the diocese/organization
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="pt-6 border-t border-gray-200">
            ...
            <div className="mt-4 space-y-4">
              <div className="flex items-center justify-between">
                ...
                >
                  ...
                  <span
                    aria-hidden="true"
                    className={classNames(
                      currentSettings.notificationSettings.emailNotifications ? 'translate-x-5' : 'translate-x-0',
                      'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out'
                    )}
                  />
                </Switch>
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  ...
                  <span
                    aria-hidden="true"
                    className={classNames(
                      currentSettings.notificationSettings.smsNotifications ? 'translate-x-5' : 'translate-x-0',
                      'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out'
                    )}
                  />
                </Switch>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <label htmlFor="transferNotifications" className="text-sm font-medium text-gray-700">
                    Member Transfer Notifications
                  </label>
                  <p className="text-xs text-gray-500">
                    Receive notifications when members are transferred to/from this branch
                  </p>
                </div>
                <Switch
                ...
                >
                  ...
                  <span
                    aria-hidden="true"
                    className={classNames(
                      currentSettings.notificationSettings.transferNotifications ? 'translate-x-5' : 'translate-x-0',
                      'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out'
                    )}
                  />
                </Switch>
