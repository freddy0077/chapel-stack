...
export default function BranchMembersPanel({ branchId }: BranchMembersPanelProps) {
      ...
      <div className="overflow-x-auto">
        {isLoading ? (
          ...
          <div className="p-8 text-center text-gray-500 dark:text-gray-400">
            ...
            <p>No members found{searchTerm ? ` matching "${searchTerm}"` : ""}</p>
          </div>
        ) : (
                    ...
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-10 w-10">
                        {member.profileImageUrl ? (
                          <img className="h-10 w-10 rounded-full" src={member.profileImageUrl} alt="" />
                        ) : (
          ...
          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300">
                ...
                <span className="font-medium">
                  {members.length < pageSize ? page * pageSize + members.length : 'many'}
                </span>{' '}
                results
              </p>
            </div>
