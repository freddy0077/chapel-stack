...
const navigationItems = [
  { id: 'overview', label: 'Overview', icon: HomeIcon, description: 'Branch dashboard and key metrics' },
  { id: 'members', label: 'Members', icon: UsersIcon, description: 'Manage branch members' },
  { id: 'ministries', label: 'Ministries', icon: BuildingLibraryIcon, description: 'Ministry management' },
  { id: 'pastoral-care', label: 'Pastoral Care', icon: HeartIcon, description: 'Prayer requests and counseling' },
  { id: 'sacraments', label: 'Sacraments', icon: DocumentTextIcon, description: 'Baptisms, communion, marriages' },
  { id: 'sermons', label: 'Sermons', icon: SpeakerWaveIcon, description: 'Sermon library and speakers' },
  { id: 'transfers', label: 'Transfers', icon: ArrowsRightLeftIcon, description: 'Member transfers' },
  { id: 'user-roles', label: 'User Roles', icon: UserGroupIcon, description: 'Role management' },
  { id: 'settings', label: 'Settings', icon: CogIcon, description: 'Branch configuration' },
  { id: 'edit', label: 'Edit Branch', icon: PencilIcon, description: 'Edit branch details' },
];
...
export default function BranchDetailPage() {
      ...
      <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">Loading branch details...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-white">Branch not found</h3>
            <p className="mt-2 text-gray-600 dark:text-gray-400">The branch you're looking for doesn't exist or you don't have access to it.</p>
            <Link 
  ...
  const renderContent = () => {
    switch (activeSection) {
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <p className="text-sm font-medium text-blue-900 dark:text-blue-100">Manage Members</p>
                </button>
                <button 
                ...
                >
                  ...
                  <p className="text-sm font-medium text-pink-900 dark:text-pink-100">Pastoral Care</p>
                </button>
                <button 
                ...
                >
                  ...
                  <p className="text-sm font-medium text-purple-900 dark:text-purple-100">Sermons</p>
                </button>
                <button 
                ...
                >
                  ...
                  <p className="text-sm font-medium text-green-900 dark:text-green-100">Ministries</p>
                </button>
              </div>
            </div>
                ...
                <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">Latest branch activities</p>
                    </div>
                  </div>
                ...
                <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">Next scheduled events</p>
                    </div>
                  </div>
                  <Link 
      ...
      case 'transfers':
        return <MemberTransferPanel branchId={branch.id} branchName={branch.name} />;
      case 'user-roles':
        return (
        ...
        return (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Edit Branch Details</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Update branch information and settings</p>
            </div>
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white truncate">{branch.name}</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Branch Details</p>
                </div>
              </div>
              <button
                onClick={() => setSidebarOpen(false)}
            ...
            <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
              {navigationItems
                .filter(item => {
                  ...
                  if (isSuperAdmin && (item.id === 'members' || item.id === 'ministries')) {
                    return false;
                  }
                  return true;
                })
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`text-sm font-medium truncate ${isActive ? 'text-indigo-700 dark:text-indigo-300' : ''}`}>
                        {item.label}
                      </p>
                      <p className={`text-xs truncate ${isActive ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400'}`}>
                        {item.description}
                      </p>
                    </div>
                  </button>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="lg:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3">
            <div className="flex items-center justify-between">
              ...
              <h1 className="text-lg font-semibold text-gray-900 dark:text-white truncate">{branch.name}</h1>
