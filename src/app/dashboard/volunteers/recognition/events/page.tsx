...
const MOCK_AWARDS: Award[] = [
  {
    ...
    description:
      "Awarded to the volunteer who has shown exceptional dedication and service",
    criteria:
      "Minimum 100 hours of service, leadership qualities, and positive impact",
  ...
  },
  {
    ...
    description:
      "Recognizes volunteers with consistent attendance and reliability",
  ...
  },
  {
    ...
    description:
      "Celebrates volunteers who have made a significant impact in their ministry area",
  ...
  },
  {
    ...
    description:
      "Honors volunteers who have shown exceptional leadership qualities",
    criteria:
      "Effectively led others, developed team members, and advanced ministry goals",
  ...
  },
  {
    ...
    criteria:
      "Created inclusive environment and strengthened church community bonds",
...
const MOCK_EVENTS: RecognitionEvent[] = [
  {
    ...
    description:
      "A special evening to honor our dedicated volunteers with dinner, awards, and entertainment",
  ...
  },
  {
    ...
    description:
      "Recognizing outstanding volunteers from each ministry area for their exceptional service",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1475721027785-f74ec9c7e14c?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",
  },
  {
    id: "e3",
    title: "Service Milestone Celebration",
    description:
      "Honoring volunteers who have reached significant service milestones",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1505236858219-8359eb29e329?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",
  },
  {
    id: "e4",
    title: "Leadership Recognition Breakfast",
    description:
      "A morning gathering to acknowledge our volunteer team leaders",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",
  },
  {
    id: "e5",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1519750783826-e2420f4d687f?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",
  },
];
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Celebrate and honor our dedicated volunteers with special events
              and awards.
            </p>
          </div>
                ...
                <div className="flex-1 p-6">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      {event.type === "appreciation_dinner" &&
                        "Appreciation Dinner"}
                      {event.type === "special_recognition" &&
                        "Special Recognition"}
                      {event.type === "volunteer_spotlight" &&
                        "Volunteer Spotlight"}
                    </span>
                  </div>
                    ...
                    {event.attendees.length > 0 && (
                      <div className="flex -space-x-2 mr-4">
                        {event.attendees.slice(0, 3).map((attendee) => (
                          <div
                            key={attendee.id}
                            className="relative z-0 inline-block h-8 w-8 rounded-full ring-2 ring-white tooltip"
                            title={attendee.name}
                          >
                            <img
                    ...
                    {event.awards && event.awards.length > 0 && (
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-600">
                          {event.awards.length}{" "}
                          {event.awards.length === 1 ? "Award" : "Awards"}
                        </span>
                      </div>
                    )}
                  </div>
