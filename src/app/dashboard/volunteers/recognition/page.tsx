...
const AWARDS: VolunteerAward[] = [
  {
    ...
    description:
      "Awarded to volunteers who have served over 100 hours in a calendar year",
  ...
  },
  {
    ...
    description:
      "Recognizes volunteer team leaders who exemplify servant leadership",
...
export default function VolunteerRecognitionPage() {
  ...
  const sortedRecognitions = [...filteredRecognitions].sort(
  ...
  const totalVolunteerHours = VOLUNTEER_RECOGNITIONS.reduce(
    (sum, v) => sum + v.totalHours,
    0,
  );
  const avgYearsOfService = Math.round(
    VOLUNTEER_RECOGNITIONS.reduce((sum, v) => sum + v.yearsOfService, 0) /
      VOLUNTEER_RECOGNITIONS.length,
  );
  const totalAwardsGiven = VOLUNTEER_RECOGNITIONS.reduce(
    (sum, v) => sum + v.awards.length,
    0,
  );
        ...
        <div className="lg:col-span-2 bg-white shadow overflow-hidden rounded-lg">
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Sorted by total hours contributed
            </p>
          </div>
                  ...
                  <tr key={recognition.id} className="hover:bg-gray-50">
                      ...
                      <div className="flex items-center">
                        <div>
                          <div className="text-sm font-medium text-gray-900">
                            {recognition.volunteerName}
                          </div>
                          <div className="text-xs text-gray-500">
                            {recognition.teams.join(", ")}
                          </div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 font-medium">
                        {recognition.totalHours}
                      </div>
                      <div className="text-xs text-gray-500">
                        {recognition.currentYearHours} this year
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {recognition.yearsOfService} years
                      </div>
                      <div className="text-xs text-gray-500">
                        Since {formatDate(recognition.startDate)}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <Link
                        href={`/dashboard/volunteers/recognition/${recognition.id}`}
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white shadow overflow-hidden rounded-lg">
            ...
            <div className="bg-gray-50 px-4 py-4 sm:px-6 border-t border-gray-200">
              <Link
                href="/dashboard/volunteers/recognition/milestones"
          ...
          <div className="bg-white shadow overflow-hidden rounded-lg">
            ...
            <div className="bg-gray-50 px-4 py-4 sm:px-6 border-t border-gray-200">
              <Link
                href="/dashboard/volunteers/recognition/awards/manage"
                className="text-sm font-medium text-indigo-600 hover:text-indigo-500"
              >
      ...
      <div className="mt-8 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg shadow overflow-hidden">
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="mt-2 max-w-xl text-sm text-gray-500">
            <p>
              Plan and schedule recognition events to celebrate your
              volunteers&apos; contributions. These events can be
