...
export default function Dashboard() {
  ...
  const [selectedBranchId, setSelectedBranchId] =
    useState<string>("default-branch");
    ...
    >
      <div className="flex h-screen overflow-hidden">
        ...
        >
          {/* Logo */}
          <div
            className={`h-16 ${darkMode ? "bg-gray-900" : "bg-white border-b"} flex items-center px-4`}
          >
          ...
          <div className="mt-6 flex flex-col flex-1 overflow-y-auto">
            <nav className="flex-1 space-y-1 px-2">
              {navigationItems.map((item) => (
                ...
                >
                  <item.icon
                    className={`mr-3 h-5 w-5 flex-shrink-0 ${item.current ? "text-indigo-500" : ""}`}
                    aria-hidden="true"
                  />
            ...
            {/* User profile */}
            <div
              className={`mt-auto p-4 ${darkMode ? "bg-gray-800" : "bg-white"} border-t ${darkMode ? "border-gray-700" : "border-gray-200"}`}
            >
              <div className="flex items-center">
                ...
                {sidebarOpen && (
                  <div className="ml-3">
                    <p
                      className={`text-sm font-medium ${darkMode ? "text-white" : "text-gray-700"}`}
                    >
              ...
              {sidebarOpen && dropdownOpen && (
                <div
                  className={`mt-2 p-2 rounded-md ${darkMode ? "bg-gray-700" : "bg-gray-50"}`}
                >
                  <a
                    href="/profile"
        ...
        <div className="flex flex-col flex-1 overflow-auto">
          {/* Top navbar */}
          <div
            className={`h-16 ${darkMode ? "bg-gray-800" : "bg-white"} border-b ${darkMode ? "border-gray-700" : "border-gray-200"} shadow-sm flex items-center justify-between px-4`}
          >
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                {notificationsOpen && (
                  <div
                    className={`absolute right-0 mt-2 w-80 rounded-md shadow-lg ${darkMode ? "bg-gray-800 ring-gray-700" : "bg-white ring-black ring-opacity-5"} ring-1 overflow-hidden z-50`}
                  >
                    ...
                    <div className="max-h-64 overflow-y-auto">
                      ...
                      <div
                        className={`p-4 ${darkMode ? "hover:bg-gray-700" : "hover:bg-gray-50"} cursor-pointer`}
                      >
                        <p className="text-sm">
                      ...
                      >
                        <p className="text-sm">
                          Meeting reminder: Staff meeting
                        </p>
                        <p
                          className={`text-xs ${darkMode ? "text-gray-400" : "text-gray-500"}`}
                        >
                    ...
                    <div
                      className={`p-2 ${darkMode ? "border-t border-gray-700" : "border-t border-gray-200"} text-center`}
                    >
                      <a
                        href="/notifications"
