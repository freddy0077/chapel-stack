...
const createReminderSchema = z.object({
  ...
  followUpType: z.enum(['FOLLOW_UP_VISIT', 'PHONE_CALL', 'EMAIL', 'PRAYER_REQUEST', 'COUNSELING_SESSION', 'PASTORAL_VISIT', 'OTHER']),
...
export default function CreateReminderForm({ onClose, onCreateReminder, prefilledData }: CreateReminderFormProps) {
  ...
  const selectedType = followUpTypes.find(type => type.value === selectedFollowUpType);
      ...
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full sm:p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            {/* Follow-up Type */}
            <div>
              <label htmlFor="followUpType" className="block text-sm font-medium text-gray-700 mb-1">
                Follow-up Type *
              </label>
              <select
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                />
                <p className="text-xs text-gray-500 mt-1">When to send the reminder notification</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">The member this reminder is about</p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Who should handle this reminder</p>
              </div>
            </div>
            ...
            {/* Action Required */}
            <div>
              <label htmlFor="actionRequired" className="block text-sm font-medium text-gray-700 mb-1">
                Action Required
              </label>
              <textarea
            ...
            {selectedType && (
              <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                <h4 className="text-sm font-medium text-blue-900 mb-2">Reminder Preview</h4>
                <div className="text-sm text-blue-800">
                  <p><strong>Type:</strong> {selectedType.icon} {selectedType.label}</p>
                  {dueDate && (
