...
export default function ModuleSettingsPage() {
  ...
  const handleReset = () => {
    if (window.confirm('Are you sure you want to reset all module preferences? This will reset your church profile and require you to go through onboarding again.')) {
      setIsResetting(true);
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-6">
        ...
        <Text className="text-gray-600 mt-1">
          Customize which modules and features are available in your church management system.
        </Text>
      </div>
        ...
        <div className="mb-6">
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center">
            ...
            <Text className="text-green-700">
              Your module preferences have been saved successfully. The navigation menu will update to reflect your changes.
            </Text>
          </div>
        </div>
      )}
        ...
        <Card>
          ...
          <div className="mb-2">
            <Text className="text-gray-600">
              Select which modules you want to enable in your church management system.
              Changes will affect which features and menu items are available to users.
            </Text>
          </div>
      ...
      <div className="border-t pt-6 mt-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <Text className="text-gray-600 mt-1">
              Reset all module preferences and go through the onboarding process again.
            </Text>
          </div>
          <Button
            variant="secondary"
