  ...
  useEffect(() => {
    if (data?.settings) {
      for (const setting of data.settings) {
        ...
        if (setting.key === "loginAlerts")
          setLoginAlerts(setting.value === "true");
          ...
          <div className="mt-4 grid grid-cols-1 gap-y-4 sm:grid-cols-6">
            ...
            <div className="sm:col-span-4">
              <button
                ...
                disabled={
                  !password || !confirmPassword || !currentPassword || isSaving
                }
        ...
        <div className="pt-6">
          ...
          <div className="mt-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                Receive email alerts when your account is accessed from a new
                device or location
              </p>
            </div>
            <Switch
            ...
            <table className="min-w-full divide-y divide-gray-300">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th
                    scope="col"
                    className="hidden px-3 py-3.5 text-left text-xs font-medium uppercase tracking-wide text-gray-500 sm:table-cell"
                  >
                    Date & Time
                  </th>
                  <th
                    scope="col"
                    className="hidden px-3 py-3.5 text-left text-xs font-medium uppercase tracking-wide text-gray-500 lg:table-cell"
                  >
                    IP Address
                  </th>
                  <th
