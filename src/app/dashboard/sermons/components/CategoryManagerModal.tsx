...
import { X, AlertCircle, Search, Tag, Calendar, Database, Plus, Edit, Trash2 } from 'lucide-react';
import { useCategories, useCreateCategory, useUpdateCategory, useDeleteCategory } from '@/graphql/hooks/useSermon';
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-indigo-50">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Create, edit, and manage sermon categories</p>
            </div>
          </div>
