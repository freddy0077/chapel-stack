...
const WORKFLOW_SUGGESTIONS = [
  {
    ...
    description:
      "Automatically send a warm welcome message and information packet to new members",
  ...
  },
  {
    ...
    description:
      "Send timely reminders for upcoming services, events, and activities",
  ...
  },
  {
    ...
    title: "Thank Donors",
    description:
      "Express gratitude and provide receipts for donations automatically",
  ...
  },
  {
    ...
    description:
      "Nurture first-time visitors with thoughtful follow-up communications",
...
export default function WorkflowsPage() {
  ...
  const activeTemplates = templates.filter(
    (t: WorkflowTemplate) => t.status === "ACTIVE",
  ).length;
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Transform your church operations with intelligent automation. Save
              hours every week by automating repetitive tasks and never miss
              important follow-ups again.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <Card
                className="border-2 border-dashed border-indigo-200 hover:border-indigo-400 transition-all duration-200 cursor-pointer group"
              ...
              >
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Get started instantly with pre-built workflow templates for
              ...
              <Card
                className="border-2 border-dashed border-green-200 hover:border-green-400 transition-all duration-200 cursor-pointer group"
              ...
              >
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Create a completely custom workflow tailored to your
                    specific needs
                  </p>
                  <Button
                    variant="outline"
          ...
          <div className="mb-12">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                See what other churches are automating
              </p>
            </div>
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div
                        className={`p-3 bg-gradient-to-r ${suggestion.color} rounded-lg text-white`}
                      >
                        {suggestion.icon}
                      </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="space-y-1">
                            ...
                            {suggestion.actions.map((action, index) => (
                              <div
                                key={index}
                                className="flex items-center text-sm text-gray-500 ml-5"
                              >
            ...
            <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Our team is here to help you set up workflows that will
                  transform your church operations. We can guide you through the
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {activeTemplates} active • {totalExecutions} total runs •{" "}
        ...
        <Tabs defaultValue="templates" className="space-y-6">
                  ...
                  >
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-center justify-between text-xs text-gray-500">
                        ...
                        <span>
                          {template.triggerType.replace("_", " ").toLowerCase()}
                        </span>
                      </div>
                    </CardContent>
                  </Card>
          ...
          <TabsContent value="analytics">
            <WorkflowStats
              templates={templates}
              executions={executions}
              loading={templatesLoading || executionsLoading}
            />
          </TabsContent>
        </Tabs>
      </div>
