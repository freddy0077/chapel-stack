...
import { Member, UpdateMemberInput, MembershipStatus, MembershipType, Gender, MaritalStatus, PrivacyLevel } from '../types/member.types';
...
const EditMemberModal: React.FC<EditMemberModalProps> = ({ isOpen, onClose, member, onSuccess }) => {
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              {/* Membership */}
              <div>
                <h4 className="text-sm font-medium text-gray-700 mb-3">Membership</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={e => handleChange('membershipStatus', e.target.value as MembershipStatus)}
                    >
