...
const PrivacySection: React.FC<PrivacySectionProps> = ({ member }) => {
  ...
  const hasDeactivationInfo =
    member.isDeactivated || member.deactivatedAt || member.deactivationReason;
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex items-center mt-1">
                ...
                <span
                  className={`ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getPrivacyLevelColor(member.privacyLevel)}`}
                >
                  {member.privacyLevel}
                </span>
              </div>
              ...
              {member.dataRetentionDate && (
                <div className="md:col-span-2">
                  ...
                  <div className="flex items-center">
                    <CalendarIcon className="w-4 h-4 text-gray-400 mr-2" />
                    <p className="text-sm text-gray-900">
                      {formatDate(member.dataRetentionDate)}
                    </p>
                  </div>
                </div>
              )}
        ...
        {hasCommunicationPrefs && member.communicationPrefs && (
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              <div className="flex items-center">
                <div
                  className={`w-3 h-3 rounded-full mr-2 ${member.communicationPrefs.emailNotifications ? "bg-green-500" : "bg-gray-300"}`}
                ></div>
              ...
              <div className="flex items-center">
                <div
                  className={`w-3 h-3 rounded-full mr-2 ${member.communicationPrefs.smsNotifications ? "bg-green-500" : "bg-gray-300"}`}
                ></div>
              ...
              <div className="flex items-center">
                <div
                  className={`w-3 h-3 rounded-full mr-2 ${member.communicationPrefs.phoneCallsAllowed ? "bg-green-500" : "bg-gray-300"}`}
                ></div>
              ...
              <div className="flex items-center">
                <div
                  className={`w-3 h-3 rounded-full mr-2 ${member.communicationPrefs.mailNotifications ? "bg-green-500" : "bg-gray-300"}`}
                ></div>
              ...
              <div className="flex items-center">
                <div
                  className={`w-3 h-3 rounded-full mr-2 ${member.communicationPrefs.pushNotifications ? "bg-green-500" : "bg-gray-300"}`}
                ></div>
              ...
              <div className="flex items-center">
                <div
                  className={`w-3 h-3 rounded-full mr-2 ${member.communicationPrefs.eventReminders ? "bg-green-500" : "bg-gray-300"}`}
                ></div>
