  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Alternative Contact */}
        {(member.alternativeEmail || member.alternativePhone || member.alternatePhone) && (
          <div className="space-y-4">
            <h4 className="text-md font-medium text-gray-900">Alternative Contact</h4>
            
            {member.alternativeEmail && (
              <div>
                <label className="text-sm font-medium text-gray-500">Alternative Email</label>
                <div className="flex items-center">
                  <EnvelopeIcon className="w-4 h-4 text-gray-400 mr-2" />
                  <a 
      ...
      {/* Address Information */}
      {(fullAddress || member.district || member.region || member.digitalAddress || member.landmark) && (
        <div className="mt-6 pt-6 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {member.digitalAddress && (
              <div>
                <label className="text-sm font-medium text-gray-500">Digital Address</label>
                <div className="flex items-center">
                  <GlobeAltIcon className="w-4 h-4 text-gray-400 mr-2" />
                  <p className="text-sm text-gray-900">{member.digitalAddress}</p>
                </div>
              </div>
            )}
