    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Membership status and spiritual milestones
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value={MembershipStatus.ACTIVE_MEMBER}>
                Active Member
              </option>
              <option value={MembershipStatus.INACTIVE_MEMBER}>
                Inactive Member
              </option>
            ...
            <input
              ...
              value={
                formData.baptismDate
                  ? new Date(formData.baptismDate).toISOString().split("T")[0]
                  : ""
              }
              onChange={(e) =>
                handleInputChange(
            ...
            <input
              ...
              value={
                formData.confirmationDate
                  ? new Date(formData.confirmationDate)
                      .toISOString()
                      .split("T")[0]
                  : ""
              }
            ...
            <input
              ...
              value={
                formData.salvationDate
                  ? new Date(formData.salvationDate).toISOString().split("T")[0]
                  : ""
              }
              onChange={(e) =>
                handleInputChange(
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            handleInputChange("statusChangeReason", e.target.value)
          }
          rows={3}
          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
