...
export default function MemberInfo({ member, event, onClose }: MemberInfoProps) {
  return (
    <div className="fixed inset-x-0 bottom-0 pb-6 px-4 sm:px-6 lg:px-8 z-20">
      <div 
        className="bg-white rounded-t-xl shadow-lg border border-gray-200 overflow-hidden transform transition-transform duration-300 ease-in-out"
      >
        <div className="relative p-4">
          ...
          <div className="mt-4 p-3 bg-green-50 rounded-lg border border-green-100">
            <div className="flex items-center text-green-800">
              ...
              <div>
                <p className="text-sm font-medium">Successfully checked in to:</p>
