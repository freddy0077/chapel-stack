  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">
        Authentication Persistence Debug
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div>
              <strong>Organisation ID:</strong> {user?.organisationId || "None"}
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="space-y-2 text-sm">
            <div>
              <strong>LocalStorage Token:</strong> {debugInfo.localStorageToken}
            </div>
            <div>
              <strong>Cookie Token:</strong> {debugInfo.cookieToken}
            </div>
            <div>
              <strong>User Data Stored:</strong>{" "}
              {debugInfo.localStorageUserData ? "Yes" : "No"}
            </div>
            <div>
